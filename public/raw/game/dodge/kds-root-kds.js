(function (root, factory) {
  ...
  var minus_1 = Kotlin.kotlin.collections.minus_4pa84t$;
  var minus_2 = Kotlin.kotlin.collections.minus_uk696c$;
  ...
  IntArrayListSortOps.prototype = Object.create(SortOps.prototype);
  IntArrayListSortOps.prototype.constructor = IntArrayListSortOps;
  ...
  FloatArrayListSortOps.prototype = Object.create(SortOps.prototype);
  FloatArrayListSortOps.prototype.constructor = FloatArrayListSortOps;
  ...
  Object.defineProperty(ByteArrayDeque.prototype, 'hasMoreToWrite', {
    get: function () {
      return this.ring_0.availableWrite > 0;
    }
  });
  Object.defineProperty(ByteArrayDeque.prototype, 'hasMoreToRead', {
    get: function () {
      return this.ring_0.availableRead > 0;
    }
  });
  ByteArrayDeque.prototype.readOne = function () {
    this.read_mj6st8$(this.tempBuffer_0, 0, 1);
    return this.tempBuffer_0[0];
  };
  ByteArrayDeque.prototype.writeOne_s8j3t7$ = function (value) {
    this.tempBuffer_0[0] = value;
    this.write_mj6st8$(this.tempBuffer_0, 0, 1);
  };
  ByteArrayDeque.prototype.hashCode = function () {
    return this.ring_0.hashCode();
  };
  ByteArrayDeque.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, ByteArrayDeque) && ((tmp$ = this.ring_0) != null ? tmp$.equals(other.ring_0) : null);
  };
  ...
  Object.defineProperty(ShortArrayDeque.prototype, 'hasMoreToWrite', {
    get: function () {
      return this.ring_0.availableWrite > 0;
    }
  });
  Object.defineProperty(ShortArrayDeque.prototype, 'hasMoreToRead', {
    get: function () {
      return this.ring_0.availableRead > 0;
    }
  });
  ShortArrayDeque.prototype.readOne = function () {
    this.read_359eei$(this.tempBuffer_0, 0, 1);
    return this.tempBuffer_0[0];
  };
  ShortArrayDeque.prototype.writeOne_mq22fl$ = function (value) {
    this.tempBuffer_0[0] = value;
    this.write_359eei$(this.tempBuffer_0, 0, 1);
  };
  ...
  ShortArrayDeque.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, ShortArrayDeque) && ((tmp$ = this.ring_0) != null ? tmp$.equals(other.ring_0) : null);
  };
  ...
  Object.defineProperty(IntArrayDeque.prototype, 'hasMoreToWrite', {
    get: function () {
      return this.ring_0.availableWrite > 0;
    }
  });
  Object.defineProperty(IntArrayDeque.prototype, 'hasMoreToRead', {
    get: function () {
      return this.ring_0.availableRead > 0;
    }
  });
  IntArrayDeque.prototype.readOne = function () {
    this.read_nd5v6f$(this.tempBuffer_0, 0, 1);
    return this.tempBuffer_0[0];
  };
  IntArrayDeque.prototype.writeOne_za3lpa$ = function (value) {
    this.tempBuffer_0[0] = value;
    this.write_nd5v6f$(this.tempBuffer_0, 0, 1);
  };
  IntArrayDeque.prototype.hashCode = function () {
    return this.ring_0.hashCode();
  };
  IntArrayDeque.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, IntArrayDeque) && ((tmp$ = this.ring_0) != null ? tmp$.equals(other.ring_0) : null);
  };
  ...
  Object.defineProperty(FloatArrayDeque.prototype, 'hasMoreToWrite', {
    get: function () {
      return this.ring_0.availableWrite > 0;
    }
  });
  Object.defineProperty(FloatArrayDeque.prototype, 'hasMoreToRead', {
    get: function () {
      return this.ring_0.availableRead > 0;
    }
  });
  FloatArrayDeque.prototype.readOne = function () {
    this.read_kgymra$(this.tempBuffer_0, 0, 1);
    return this.tempBuffer_0[0];
  };
  FloatArrayDeque.prototype.writeOne_mx4ult$ = function (value) {
    this.tempBuffer_0[0] = value;
    this.write_kgymra$(this.tempBuffer_0, 0, 1);
  };
  ...
  FloatArrayDeque.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, FloatArrayDeque) && ((tmp$ = this.ring_0) != null ? tmp$.equals(other.ring_0) : null);
  };
  ...
  function IntArrayList(capacity) {
    IntArrayList$Companion_getInstance();
    if (capacity === void 0)
      capacity = 7;
    var tmp$;
  ...
  function IntArrayList$Companion() {
    IntArrayList$Companion_instance = this;
  }
  IntArrayList$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var IntArrayList$Companion_instance = null;
  function IntArrayList$Companion_getInstance() {
    if (IntArrayList$Companion_instance === null) {
      new IntArrayList$Companion();
    }return IntArrayList$Companion_instance;
  }
  ...
  IntArrayList.prototype.get_za3lpa$ = function (index) {
    return this.getAt_za3lpa$(index);
  };
  IntArrayList.prototype.getAt_za3lpa$ = function (index) {
    return this.data[index];
  };
  IntArrayList.prototype.setAt_vux9f0$ = function (index, value) {
    this.set_vux9f0$(index, value);
    return value;
  };
  ...
  IntArrayList.prototype.insertAt_vux9f0$ = function (index, value) {
    this.ensure_0(1);
    if (!this.isEmpty())
      arraycopy_1(this.data, index, this.data, index + 1 | 0, this.length_0 - index | 0);
    this.data[index] = value;
    this.length_0 = this.length_0 + 1 | 0;
    return this;
  };
  IntArrayList.prototype.insertAt_coga0j$ = function (index, value, start, end) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = value.length;
    ...
    this.ensure_0(count);
    if (!this.isEmpty())
      arraycopy_1(this.data, index, this.data, index + count | 0, this.length_0 - index | 0);
    for (var n = 0; n < count; n++)
      this.data[index + n | 0] = value[start + n | 0];
    this.length_0 = this.length_0 + count | 0;
    return this;
  };
  IntArrayList.prototype.swapIndices_vux9f0$ = function (indexA, indexB) {
    this.swap_vux9f0$(indexA, indexB);
  };
  IntArrayList.prototype.swap_vux9f0$ = function (indexA, indexB) {
    var l = this.getAt_za3lpa$(indexA);
    var r = this.getAt_za3lpa$(indexB);
    this.set_vux9f0$(indexA, r);
    this.set_vux9f0$(indexB, l);
  };
  IntArrayList.prototype.removeAt_za3lpa$ = function (index) {
    return this.removeAt_vux9f0$(index, 1);
  };
  IntArrayList.prototype.removeAt_vux9f0$ = function (index, count) {
    if (index < 0 || index >= this.length_0 || (index + count | 0) > this.length_0)
      throw IndexOutOfBoundsException_init();
    var out = this.data[index];
    if (count > 0) {
      if (index < (this.length_0 - count | 0))
        arraycopy_1(this.data, index + count | 0, this.data, index, this.length_0 - index - count | 0);
      this.length_0 = this.length_0 - count | 0;
    }return out;
  };
  ...
  IntArrayList.prototype.toString = function () {
    ...
    for (var n = 0; n < tmp$; n++) {
      ...
      $receiver.append_s8jyv4$(this.getAt_za3lpa$(n));
    }
  ...
  function DoubleArrayList(capacity) {
    DoubleArrayList$Companion_getInstance();
    if (capacity === void 0)
      capacity = 7;
    var tmp$;
  ...
  function DoubleArrayList$Companion() {
    DoubleArrayList$Companion_instance = this;
  }
  DoubleArrayList$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var DoubleArrayList$Companion_instance = null;
  function DoubleArrayList$Companion_getInstance() {
    if (DoubleArrayList$Companion_instance === null) {
      new DoubleArrayList$Companion();
    }return DoubleArrayList$Companion_instance;
  }
  ...
  DoubleArrayList.prototype.getAt_za3lpa$ = function (index) {
    return this.data[index];
  };
  DoubleArrayList.prototype.setAt_5wr77w$ = function (index, value) {
  ...
  DoubleArrayList.prototype.insertAt_5wr77w$ = function (index, value) {
    this.ensure_0(1);
    if (!this.isEmpty())
      arraycopy_3(this.data, index, this.data, index + 1 | 0, this.length_0 - index | 0);
    this.data[index] = value;
    this.length_0 = this.length_0 + 1 | 0;
    return this;
  };
  DoubleArrayList.prototype.insertAt_q6hait$ = function (index, value, start, end) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = value.length;
    ...
    this.ensure_0(count);
    if (!this.isEmpty())
      arraycopy_3(this.data, index, this.data, index + count | 0, this.length_0 - index | 0);
    for (var n = 0; n < count; n++)
      this.data[index + n | 0] = value[start + n | 0];
    this.length_0 = this.length_0 + count | 0;
    return this;
  };
  DoubleArrayList.prototype.swapIndices_vux9f0$ = function (indexA, indexB) {
    this.swap_vux9f0$(indexA, indexB);
  };
  DoubleArrayList.prototype.swap_vux9f0$ = function (indexA, indexB) {
    var l = this.getAt_za3lpa$(indexA);
    var r = this.getAt_za3lpa$(indexB);
    this.set_5wr77w$(indexA, r);
    this.set_5wr77w$(indexB, l);
  };
  DoubleArrayList.prototype.removeAt_za3lpa$ = function (index) {
    return this.removeAt_vux9f0$(index, 1);
  };
  DoubleArrayList.prototype.removeAt_vux9f0$ = function (index, count) {
    if (index < 0 || index >= this.length_0 || (index + count | 0) > this.length_0)
      throw IndexOutOfBoundsException_init();
    var out = this.data[index];
    if (count > 0) {
      if (index < (this.length_0 - count | 0))
        arraycopy_3(this.data, index + count | 0, this.data, index, this.length_0 - index - count | 0);
      this.length_0 = this.length_0 - count | 0;
    }return out;
  };
  ...
  function FloatArrayList(capacity) {
    FloatArrayList$Companion_getInstance();
    if (capacity === void 0)
      capacity = 7;
    var tmp$;
  ...
  function FloatArrayList$Companion() {
    FloatArrayList$Companion_instance = this;
  }
  FloatArrayList$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var FloatArrayList$Companion_instance = null;
  function FloatArrayList$Companion_getInstance() {
    if (FloatArrayList$Companion_instance === null) {
      new FloatArrayList$Companion();
    }return FloatArrayList$Companion_instance;
  }
  ...
  FloatArrayList.prototype.getAt_za3lpa$ = function (index) {
    return this.data[index];
  };
  FloatArrayList.prototype.setAt_24o109$ = function (index, value) {
    this.set_24o109$(index, value);
    return value;
  };
  ...
  FloatArrayList.prototype.insertAt_24o109$ = function (index, value) {
    this.ensure_0(1);
    if (!this.isEmpty())
      arraycopy_2(this.data, index, this.data, index + 1 | 0, this.length_0 - index | 0);
    this.data[index] = value;
    this.length_0 = this.length_0 + 1 | 0;
    return this;
  };
  FloatArrayList.prototype.insertAt_3hvitc$ = function (index, value, start, end) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = value.length;
    ...
    this.ensure_0(count);
    if (!this.isEmpty())
      arraycopy_2(this.data, index, this.data, index + count | 0, this.length_0 - index | 0);
    for (var n = 0; n < count; n++)
      this.data[index + n | 0] = value[start + n | 0];
    this.length_0 = this.length_0 + count | 0;
    return this;
  };
  FloatArrayList.prototype.swapIndices_vux9f0$ = function (indexA, indexB) {
    this.swap_vux9f0$(indexA, indexB);
  };
  FloatArrayList.prototype.swap_vux9f0$ = function (indexA, indexB) {
    var l = this.getAt_za3lpa$(indexA);
    var r = this.getAt_za3lpa$(indexB);
    this.set_24o109$(indexA, r);
    this.set_24o109$(indexB, l);
  };
  FloatArrayList.prototype.removeAt_za3lpa$ = function (index) {
    return this.removeAt_vux9f0$(index, 1);
  };
  FloatArrayList.prototype.removeAt_vux9f0$ = function (index, count) {
    if (index < 0 || index >= this.length_0 || (index + count | 0) > this.length_0)
      throw IndexOutOfBoundsException_init();
    var out = this.data[index];
    if (count > 0) {
      if (index < (this.length_0 - count | 0))
        arraycopy_2(this.data, index + count | 0, this.data, index, this.length_0 - index - count | 0);
      this.length_0 = this.length_0 - count | 0;
    }return out;
  };
  ...
  IntArrayListSortOps.prototype.compare_8olpll$ = function (subject, l, r) {
    return Kotlin.primitiveCompareTo(subject.getAt_za3lpa$(l), subject.getAt_za3lpa$(r));
  };
  IntArrayListSortOps.prototype.swap_8olpll$ = function (subject, indexL, indexR) {
    var l = subject.getAt_za3lpa$(indexL);
    var r = subject.getAt_za3lpa$(indexR);
    subject.set_vux9f0$(indexR, l);
    subject.set_vux9f0$(indexL, r);
  };
  IntArrayListSortOps.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'IntArrayListSortOps',
    interfaces: [SortOps]
  };
  var IntArrayListSortOps_instance = null;
  ...
  DoubleArrayListSortOps.prototype.compare_8olpll$ = function (subject, l, r) {
    return Kotlin.compareTo(subject.getAt_za3lpa$(l), subject.getAt_za3lpa$(r));
  };
  DoubleArrayListSortOps.prototype.swap_8olpll$ = function (subject, indexL, indexR) {
    var l = subject.getAt_za3lpa$(indexL);
    var r = subject.getAt_za3lpa$(indexR);
    subject.set_5wr77w$(indexR, l);
    subject.set_5wr77w$(indexL, r);
  };
  DoubleArrayListSortOps.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'DoubleArrayListSortOps',
    interfaces: [SortOps]
  };
  var DoubleArrayListSortOps_instance = null;
  ...
  FloatArrayListSortOps.prototype.compare_8olpll$ = function (subject, l, r) {
    return Kotlin.compareTo(subject.getAt_za3lpa$(l), subject.getAt_za3lpa$(r));
  };
  FloatArrayListSortOps.prototype.swap_8olpll$ = function (subject, indexL, indexR) {
    var l = subject.getAt_za3lpa$(indexL);
    var r = subject.getAt_za3lpa$(indexR);
    subject.set_24o109$(indexR, l);
    subject.set_24o109$(indexL, r);
  };
  FloatArrayListSortOps.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'FloatArrayListSortOps',
    interfaces: [SortOps]
  };
  var FloatArrayListSortOps_instance = null;
  ...
  function sort($receiver, start, end, reversed) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = $receiver.size;
    if (reversed === void 0)
      reversed = false;
    return genericSort_0($receiver, start, end - 1 | 0, IntArrayListSortOps_getInstance(), reversed);
  }
  function sort_0($receiver, start, end, reversed) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = $receiver.size;
    if (reversed === void 0)
      reversed = false;
    return genericSort_0($receiver, start, end - 1 | 0, DoubleArrayListSortOps_getInstance(), reversed);
  }
  function sort_1($receiver, start, end, reversed) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = $receiver.size;
    if (reversed === void 0)
      reversed = false;
    return genericSort_0($receiver, start, end - 1 | 0, FloatArrayListSortOps_getInstance(), reversed);
  }
  function reverse($receiver, start, end) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = $receiver.size;
    IntArrayListSortOps_getInstance().reverse_8olpll$($receiver, start, end - 1 | 0);
  }
  function reverse_0($receiver, start, end) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = $receiver.size;
    DoubleArrayListSortOps_getInstance().reverse_8olpll$($receiver, start, end - 1 | 0);
  }
  function reverse_1($receiver, start, end) {
    if (start === void 0)
      start = 0;
    if (end === void 0)
      end = $receiver.size;
    FloatArrayListSortOps_getInstance().reverse_8olpll$($receiver, start, end - 1 | 0);
  }
  ...
  BitSet.prototype.hashCode = function () {
    return contentHashCode(this.data) + this.size | 0;
  };
  BitSet.prototype.equals = function (other) {
    return Kotlin.isType(other, BitSet) && this.size === other.size && contentEquals(this.data, other.data);
  };
  BitSet.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'BitSet',
  ...
  CacheMap.prototype.equals = function (other) {
    return Kotlin.isType(other, CacheMap) && equals(this.map_0, other.map_0) && equals(this.free, other.free);
  };
  CacheMap.prototype.hashCode = function () {
    return hashCode(this.map_0) + this.maxSize | 0;
  };
  ...
  CaseInsensitiveStringMap.prototype.equals = function (other) {
    return Kotlin.isType(other, CaseInsensitiveStringMap) && equals(this.mapLC_0, other.mapLC_0);
  };
  CaseInsensitiveStringMap.prototype.hashCode = function () {
    return hashCode(this.mapLC_0);
  };
  ...
  function CopyOnWriteFrozenList() {
    this.list_0 = new KdsAtomicRef(emptyList());
  }
  Object.defineProperty(CopyOnWriteFrozenList.prototype, 'size', {
    get: function () {
      return this.list_0.value.size;
    }
  });
  CopyOnWriteFrozenList.prototype.contains_11rb$ = function (element) {
    return this.list_0.value.contains_11rb$(element);
  };
  CopyOnWriteFrozenList.prototype.containsAll_brywnq$ = function (elements) {
    return this.list_0.value.containsAll_brywnq$(elements);
  };
  CopyOnWriteFrozenList.prototype.get_za3lpa$ = function (index) {
    return this.list_0.value.get_za3lpa$(index);
  };
  CopyOnWriteFrozenList.prototype.indexOf_11rb$ = function (element) {
    return this.list_0.value.indexOf_11rb$(element);
  };
  CopyOnWriteFrozenList.prototype.isEmpty = function () {
    return this.list_0.value.isEmpty();
  };
  CopyOnWriteFrozenList.prototype.iterator = function () {
    return asFakeMutable_2(this.list_0.value.iterator());
  };
  CopyOnWriteFrozenList.prototype.lastIndexOf_11rb$ = function (element) {
    return this.list_0.value.lastIndexOf_11rb$(element);
  };
  CopyOnWriteFrozenList.prototype.add_11rb$ = function (element) {
    this.list_0.value = plus(this.list_0.value, element);
    return true;
  };
  CopyOnWriteFrozenList.prototype.add_wxm5ur$ = function (index, element) {
    var oldList = this.list_0.value;
    this.list_0.value = plus_0(plus(slice(oldList, until(0, index)), element), slice(oldList, until(index, oldList.size)));
  };
  CopyOnWriteFrozenList.prototype.addAll_u57x28$ = function (index, elements) {
    var oldList = this.list_0.value;
    this.list_0.value = plus_0(plus_0(slice(oldList, until(0, index)), elements), slice(oldList, until(index, oldList.size)));
    return true;
  };
  CopyOnWriteFrozenList.prototype.addAll_brywnq$ = function (elements) {
    this.list_0.value = plus_0(this.list_0.value, elements);
    return true;
  };
  CopyOnWriteFrozenList.prototype.clear = function () {
    this.list_0.value = emptyList();
  };
  CopyOnWriteFrozenList.prototype.listIterator = function () {
    return asFakeMutable_3(this.list_0.value.listIterator());
  };
  CopyOnWriteFrozenList.prototype.listIterator_za3lpa$ = function (index) {
    return asFakeMutable_3(this.list_0.value.listIterator_za3lpa$(index));
  };
  CopyOnWriteFrozenList.prototype.remove_11rb$ = function (element) {
    var oldList = this.list_0.value;
    var $receiver = oldList.contains_11rb$(element);
    this.list_0.value = minus(oldList, element);
    return $receiver;
  };
  CopyOnWriteFrozenList.prototype.removeAll_brywnq$ = function (elements) {
    var oldList = this.list_0.value;
    var $receiver = oldList.containsAll_brywnq$(elements);
    this.list_0.value = minus_0(oldList, elements);
    return $receiver;
  };
  CopyOnWriteFrozenList.prototype.removeAt_za3lpa$ = function (index) {
    var $receiver = this.list_0.value.get_za3lpa$(index);
    var oldList = this.list_0.value;
    this.list_0.value = plus_0(slice(oldList, until(0, index)), slice(oldList, until(index + 1 | 0, oldList.size)));
    return $receiver;
  };
  CopyOnWriteFrozenList.prototype.retainAll_brywnq$ = function (elements) {
    var elementsSet = toSet(elements);
    var tmp$ = this.list_0;
    var $receiver = this.list_0.value;
    var destination = ArrayList_init();
    var tmp$_0;
    tmp$_0 = $receiver.iterator();
    while (tmp$_0.hasNext()) {
      var element = tmp$_0.next();
      if (elementsSet.contains_11rb$(element))
        destination.add_11rb$(element);
    }
    tmp$.value = destination;
    return true;
  };
  CopyOnWriteFrozenList.prototype.set_wxm5ur$ = function (index, element) {
    var oldList = this.list_0.value;
    var $receiver = oldList.get_za3lpa$(index);
    this.list_0.value = plus_0(plus(slice(oldList, until(0, index)), element), slice(oldList, until(index, oldList.size)));
    return $receiver;
  };
  CopyOnWriteFrozenList.prototype.subList_vux9f0$ = function (fromIndex, toIndex) {
    return new SubMutableList(this, fromIndex, toIndex);
  };
  CopyOnWriteFrozenList.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CopyOnWriteFrozenList',
    interfaces: [MutableList]
  };
  function CopyOnWriteFrozenMap() {
    this.map_0 = new KdsAtomicRef(emptyMap());
  }
  Object.defineProperty(CopyOnWriteFrozenMap.prototype, 'size', {
    get: function () {
      return this.map_0.value.size;
    }
  });
  CopyOnWriteFrozenMap.prototype.containsKey_11rb$ = function (key) {
    return this.map_0.value.containsKey_11rb$(key);
  };
  CopyOnWriteFrozenMap.prototype.containsValue_11rc$ = function (value) {
    return this.map_0.value.containsValue_11rc$(value);
  };
  CopyOnWriteFrozenMap.prototype.get_11rb$ = function (key) {
    return this.map_0.value.get_11rb$(key);
  };
  CopyOnWriteFrozenMap.prototype.isEmpty = function () {
    return this.map_0.value.isEmpty();
  };
  Object.defineProperty(CopyOnWriteFrozenMap.prototype, 'entries', {
    get: function () {
      return asFakeMutable_4(this.map_0.value.entries);
    }
  });
  Object.defineProperty(CopyOnWriteFrozenMap.prototype, 'keys', {
    get: function () {
      return asFakeMutable_0(this.map_0.value.keys);
    }
  });
  Object.defineProperty(CopyOnWriteFrozenMap.prototype, 'values', {
    get: function () {
      return asFakeMutable_1(this.map_0.value.values);
    }
  });
  CopyOnWriteFrozenMap.prototype.clear = function () {
    this.map_0.value = emptyMap();
  };
  CopyOnWriteFrozenMap.prototype.put_xwzc9p$ = function (key, value) {
    var $receiver = this.map_0.value.get_11rb$(key);
    this.map_0.value = plus_1(this.map_0.value, mapOf(to(key, value)));
    return $receiver;
  };
  CopyOnWriteFrozenMap.prototype.putAll_a2k3zr$ = function (from) {
    this.map_0.value = plus_1(this.map_0.value, from);
  };
  CopyOnWriteFrozenMap.prototype.remove_11rb$ = function (key) {
    var $receiver = this.map_0.value.get_11rb$(key);
    this.map_0.value = minus_1(this.map_0.value, key);
    return $receiver;
  };
  CopyOnWriteFrozenMap.prototype.removeAll_brywnq$ = function (keys) {
    this.map_0.value = minus_2(this.map_0.value, keys);
    return true;
  };
  CopyOnWriteFrozenMap.prototype.retainAll_brywnq$ = function (keys) {
    var keysSet = toSet(keys);
    var tmp$ = this.map_0;
    var $receiver = this.map_0.value;
    var tmp$_0;
    var result = LinkedHashMap_init();
    tmp$_0 = $receiver.entries.iterator();
    while (tmp$_0.hasNext()) {
      var entry = tmp$_0.next();
      if (keysSet.contains_11rb$(entry.key)) {
        result.put_xwzc9p$(entry.key, entry.value);
      }}
    tmp$.value = result;
    return true;
  };
  CopyOnWriteFrozenMap.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CopyOnWriteFrozenMap',
    interfaces: [MutableMap]
  };
  function CopyOnWriteFrozenSet() {
    this.map_0 = new CopyOnWriteFrozenMap();
  }
  Object.defineProperty(CopyOnWriteFrozenSet.prototype, 'size', {
    get: function () {
      return this.map_0.size;
    }
  });
  CopyOnWriteFrozenSet.prototype.add_11rb$ = function (element) {
    var $receiver = this.map_0.containsKey_11rb$(element);
    this.map_0.put_xwzc9p$(element, Unit);
    return $receiver;
  };
  CopyOnWriteFrozenSet.prototype.addAll_brywnq$ = function (elements) {
    var tmp$ = this.map_0;
    var result = LinkedHashMap_init_0(coerceAtLeast(mapCapacity(collectionSizeOrDefault(elements, 10)), 16));
    var tmp$_0;
    tmp$_0 = elements.iterator();
    while (tmp$_0.hasNext()) {
      var element = tmp$_0.next();
      result.put_xwzc9p$(element, Unit);
    }
    tmp$.putAll_a2k3zr$(result);
    return true;
  };
  CopyOnWriteFrozenSet.prototype.clear = function () {
    this.map_0.clear();
  };
  CopyOnWriteFrozenSet.prototype.iterator = function () {
    return this.map_0.keys.iterator();
  };
  CopyOnWriteFrozenSet.prototype.remove_11rb$ = function (element) {
    return this.map_0.remove_11rb$(element) != null;
  };
  CopyOnWriteFrozenSet.prototype.removeAll_brywnq$ = function (elements) {
    return this.map_0.removeAll_brywnq$(elements);
  };
  CopyOnWriteFrozenSet.prototype.retainAll_brywnq$ = function (elements) {
    return this.map_0.retainAll_brywnq$(elements);
  };
  CopyOnWriteFrozenSet.prototype.contains_11rb$ = function (element) {
    return this.map_0.containsKey_11rb$(element);
  };
  CopyOnWriteFrozenSet.prototype.containsAll_brywnq$ = function (elements) {
    var all$result;
    all$break: do {
      var tmp$;
      ...
      while (tmp$.hasNext()) {
        var element = tmp$.next();
        if (!this.map_0.containsKey_11rb$(element)) {
          all$result = false;
          break all$break;
        }}
      all$result = true;
  ...
  CopyOnWriteFrozenSet.prototype.isEmpty = function () {
    return this.map_0.isEmpty();
  };
  CopyOnWriteFrozenSet.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'CopyOnWriteFrozenSet',
  ...
  function TGenDeque(initialCapacity) {
    ...
    var tmp$;
    this.data_om94ys$_0 = Kotlin.isArray(tmp$ = Kotlin.newArray(initialCapacity, null)) ? tmp$ : throwCCE();
  }
  ...
  TGenDeque.prototype.addAllFirst_brywnq$ = function (items) {
    var tmp$, tmp$_0;
    this.resizeIfRequiredFor_vzb5qh$_0(items.size);
    this._start_1ejrpf$_0 = umod(this._start_1ejrpf$_0 - items.size | 0, this.capacity_cs1or0$_0);
    this._size_g2v18u$_0 = this._size_g2v18u$_0 + items.size | 0;
    var pos = this._start_1ejrpf$_0;
    tmp$ = items.iterator();
    while (tmp$.hasNext()) {
      var it = tmp$.next();
      this.data_om94ys$_0[umod((tmp$_0 = pos, pos = tmp$_0 + 1 | 0, tmp$_0), this.capacity_cs1or0$_0)] = it;
    }
  };
  ...
  function TGenDeque_init($this) {
    $this = $this || Object.create(TGenDeque.prototype);
  ...
  function IntDeque(initialCapacity) {
    ...
    var tmp$;
    this.data_wxyo2l$_0 = Kotlin.isIntArray(tmp$ = new Int32Array(initialCapacity)) ? tmp$ : throwCCE();
  }
  ...
  IntDeque.prototype.addAllFirst_wlb8mv$ = function (items) {
    var tmp$, tmp$_0;
    this.resizeIfRequiredFor_spk7l6$_0(items.size);
    this._start_ezstq4$_0 = umod(this._start_ezstq4$_0 - items.size | 0, this.capacity_mktrrh$_0);
    this._size_opro19$_0 = this._size_opro19$_0 + items.size | 0;
    var pos = this._start_ezstq4$_0;
    tmp$ = items.iterator();
    while (tmp$.hasNext()) {
      var it = tmp$.next();
      this.data_wxyo2l$_0[umod((tmp$_0 = pos, pos = tmp$_0 + 1 | 0, tmp$_0), this.capacity_mktrrh$_0)] = it;
    }
  };
  ...
  function IntDeque_init($this) {
    $this = $this || Object.create(IntDeque.prototype);
    IntDeque.call($this, 16);
    return $this;
  }
  function DoubleDeque(initialCapacity) {
    this._start_3teynm$_0 = 0;
    this._size_4gd02r$_0 = 0;
    var tmp$;
    this.data_ra8ot5$_0 = Kotlin.isDoubleArray(tmp$ = new Float64Array(initialCapacity)) ? tmp$ : throwCCE();
  }
  ...
  DoubleDeque.prototype.addAllFirst_su9dsd$ = function (items) {
    var tmp$, tmp$_0;
    this.resizeIfRequiredFor_wnkq44$_0(items.size);
    this._start_3teynm$_0 = umod(this._start_3teynm$_0 - items.size | 0, this.capacity_wo86qx$_0);
    this._size_4gd02r$_0 = this._size_4gd02r$_0 + items.size | 0;
    var pos = this._start_3teynm$_0;
    tmp$ = items.iterator();
    while (tmp$.hasNext()) {
      var it = tmp$.next();
      this.data_ra8ot5$_0[umod((tmp$_0 = pos, pos = tmp$_0 + 1 | 0, tmp$_0), this.capacity_wo86qx$_0)] = it;
    }
  };
  ...
  function DoubleDeque_init($this) {
    $this = $this || Object.create(DoubleDeque.prototype);
    DoubleDeque.call($this, 16);
    return $this;
  }
  function FloatDeque(initialCapacity) {
    ...
    var tmp$;
    this.data_sjw3ao$_0 = Kotlin.isFloatArray(tmp$ = new Float32Array(initialCapacity)) ? tmp$ : throwCCE();
  }
  ...
  FloatDeque.prototype.addAllFirst_29bubg$ = function (items) {
    var tmp$, tmp$_0;
    this.resizeIfRequiredFor_1uepdp$_0(items.size);
    this._start_ew7qyx$_0 = umod(this._start_ew7qyx$_0 - items.size | 0, this.capacity_nrrs8w$_0);
    this._size_yush0m$_0 = this._size_yush0m$_0 + items.size | 0;
    var pos = this._start_ew7qyx$_0;
    tmp$ = items.iterator();
    while (tmp$.hasNext()) {
      var it = tmp$.next();
      this.data_sjw3ao$_0[umod((tmp$_0 = pos, pos = tmp$_0 + 1 | 0, tmp$_0), this.capacity_nrrs8w$_0)] = it;
    }
  };
  ...
  function FloatDeque_init($this) {
    $this = $this || Object.create(FloatDeque.prototype);
    FloatDeque.call($this, 16);
    return $this;
  }
  function ByteDeque(initialCapacity) {
    this._start_j8k8y1$_0 = 0;
    this._size_gnxmw6$_0 = 0;
    var tmp$;
    this.data_aziqmo$_0 = Kotlin.isByteArray(tmp$ = new Int8Array(initialCapacity)) ? tmp$ : throwCCE();
  }
  ...
  ByteDeque.prototype.addAllFirst_g0r6ck$ = function (items) {
    var tmp$, tmp$_0;
    this.resizeIfRequiredFor_lphm9p$_0(items.size);
    this._start_j8k8y1$_0 = umod(this._start_j8k8y1$_0 - items.size | 0, this.capacity_6jsdz4$_0);
    this._size_gnxmw6$_0 = this._size_gnxmw6$_0 + items.size | 0;
    var pos = this._start_j8k8y1$_0;
    tmp$ = items.iterator();
    while (tmp$.hasNext()) {
      var it = tmp$.next();
      this.data_aziqmo$_0[umod((tmp$_0 = pos, pos = tmp$_0 + 1 | 0, tmp$_0), this.capacity_6jsdz4$_0)] = it;
    }
  };
  ...
  function ByteDeque_init($this) {
    $this = $this || Object.create(ByteDeque.prototype);
    ByteDeque.call($this, 16);
    return $this;
  }
  ...
  GenericSubList.prototype.equals = function (other) {
    var tmp$ = Kotlin.isType(other, GenericSubList);
    if (tmp$) {
      var count = this.size;
      var equaler$result;
      equaler$break: do {
  ...
  GenericSubList.prototype.hashCode = function () {
    ...
    for (var n = 0; n < count; n++) {
      ...
      var $receiver = this.get_za3lpa$(n);
      var tmp$_0;
      out = tmp$ + ((tmp$_0 = $receiver != null ? hashCode($receiver) : null) != null ? tmp$_0 : 0) | 0;
    }
    return out;
  };
  ...
  GenericListIterator.prototype.equals = function (other) {
    return Kotlin.isType(other, GenericListIterator) && equals(this.list, other.list) && this.index_0 === other.index_0;
  };
  GenericListIterator.prototype.hashCode = function () {
    return hashCode(this.list) + hashCode(this.index_0) | 0;
  };
  ...
  IndexedTable.prototype.equals = function (other) {
    return Kotlin.isType(other, IndexedTable) && equals(this.instances, other.instances);
  };
  IndexedTable.prototype.hashCode = function () {
    return hashCode(this.instances);
  };
  ...
  IntMap$ValueIterator.prototype.next = function () {
    return ensureNotNull(this.it_0.nextValue());
  };
  ...
  IntMap$EntryIterator.prototype.next = function () {
    var tmp$;
    return Kotlin.isType(tmp$ = this.it_0.nextEntry().copy_wxm5ur$(), IntMap$Entry) ? tmp$ : throwCCE();
  };
  ...
  IntMap.prototype.equals = function (other) {
    ...
    while (index !== 2147483646) {
      ...
      var it = tmp$;
      var key = it;
      var value = this.get_za3lpa$(it);
      if (!equals(other.get_za3lpa$(key), value))
        return false;
      index = this.nextNonEmptyIndex_u4kcgn$(this._keys, index === 2147483647 ? 0 : index + 1 | 0);
    }
    return true;
  ...
  IntMap.prototype.hashCode = function () {
    ...
    while (index !== 2147483646) {
      ...
      var value = this.get_za3lpa$(it);
      var tmp$_0;
      out.v = out.v + (hashCode(key) + ((tmp$_0 = value != null ? hashCode(value) : null) != null ? tmp$_0 : 0)) | 0;
      index = this.nextNonEmptyIndex_u4kcgn$(this._keys, index === 2147483647 ? 0 : index + 1 | 0);
    }
    return out.v;
  };
  ...
  IntFloatMap.prototype.equals = function (other) {
    if (!Kotlin.isType(other, IntMap))
      return false;
    var $this = this.i;
    var tmp$;
  ...
  IntFloatMap.prototype.hashCode = function () {
    var out = {v: 0};
    var $this = this.i;
    var tmp$;
    var index = $this.hasZero ? 2147483647 : $this.nextNonEmptyIndex_u4kcgn$($this._keys, 0);
    while (index !== 2147483646) {
      ...
      var key = it;
      var value = this.get_za3lpa$(it);
      out.v = out.v + (hashCode(key) + hashCode(value)) | 0;
      index = $this.nextNonEmptyIndex_u4kcgn$($this._keys, index === 2147483647 ? 0 : index + 1 | 0);
    }
    return out.v;
  };
  ...
  IntSet.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, IntSet) && ((tmp$ = this.data_0) != null ? tmp$.equals(other.data_0) : null);
  };
  IntSet.prototype.hashCode = function () {
    return this.data_0.hashCode();
  };
  IntSet.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'IntSet',
  ...
  ListReader.prototype.equals = function (other) {
    return Kotlin.isType(other, ListReader) && equals(this.list, other.list) && this.position === other.position;
  };
  ListReader.prototype.hashCode = function () {
  ...
  Pool.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  Pool.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, Pool) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null) && this.itemsInPool === other.itemsInPool;
  };
  ...
  function TGenPriorityQueue(data, comparator) {
    TGenPriorityQueue$Companion_getInstance();
    this.data_0 = data;
    this.comparator = comparator;
    this.size_1qzomm$_0 = 0;
  }
  function TGenPriorityQueue$Companion() {
    TGenPriorityQueue$Companion_instance = this;
  }
  TGenPriorityQueue$Companion.prototype.invoke_sir3ds$ = function (comparator, reversed_0) {
    if (reversed_0 === void 0)
      reversed_0 = false;
    var tmp$;
    return new TGenPriorityQueue(Kotlin.isArray(tmp$ = Kotlin.newArray(16, null)) ? tmp$ : throwCCE(), reversed_0 ? reversed(comparator) : comparator);
  };
  TGenPriorityQueue$Companion.prototype.invoke_km2rfd$ = function (reversed, comparator) {
    if (reversed === void 0)
      reversed = false;
    return TGenPriorityQueue$Companion_getInstance().invoke_sir3ds$(new Comparator$ObjectLiteral(comparator), reversed);
  };
  TGenPriorityQueue$Companion.prototype.invoke_eq9e3x$ = function (reversed) {
    if (reversed === void 0)
      reversed = false;
    return TGenPriorityQueue$Companion_getInstance().invoke_sir3ds$(comparator(), reversed);
  };
  TGenPriorityQueue$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var TGenPriorityQueue$Companion_instance = null;
  function TGenPriorityQueue$Companion_getInstance() {
    if (TGenPriorityQueue$Companion_instance === null) {
      new TGenPriorityQueue$Companion();
    }return TGenPriorityQueue$Companion_instance;
  }
  TGenPriorityQueue.prototype.get_value_0 = function ($receiver) {
    return this.data_0[$receiver];
  };
  TGenPriorityQueue.prototype.set_value_0 = function ($receiver, value) {
    this.data_0[$receiver] = value;
  };
  TGenPriorityQueue.prototype.get_isRoot_0 = function ($receiver) {
    return $receiver === 0;
  };
  TGenPriorityQueue.prototype.get_parent_0 = function ($receiver) {
    return ($receiver - 1 | 0) / 2 | 0;
  };
  TGenPriorityQueue.prototype.get_left_0 = function ($receiver) {
    return (2 * $receiver | 0) + 1 | 0;
  };
  TGenPriorityQueue.prototype.get_right_0 = function ($receiver) {
    return (2 * $receiver | 0) + 2 | 0;
  };
  TGenPriorityQueue.prototype.gt_0 = function (a, b) {
    return this.comparator.compare(a, b) > 0;
  };
  TGenPriorityQueue.prototype.lt_0 = function (a, b) {
    return this.comparator.compare(a, b) < 0;
  };
  Object.defineProperty(TGenPriorityQueue.prototype, 'capacity_0', {
    get: function () {
      return this.data_0.length;
    }
  });
  Object.defineProperty(TGenPriorityQueue.prototype, 'size', {
    get: function () {
      return this.size_1qzomm$_0;
    },
    set: function (size) {
      this.size_1qzomm$_0 = size;
    }
  });
  Object.defineProperty(TGenPriorityQueue.prototype, 'head', {
    get: function () {
      if (this.size <= 0)
        throw IndexOutOfBoundsException_init();
  ...
  TGenPriorityQueue.prototype.add_11rb$ = function (element) {
    this.size = this.size + 1 | 0;
  ...
  TGenPriorityQueue.prototype.removeHead = function () {
    if (this.size <= 0)
      throw IndexOutOfBoundsException_init();
    if (this.size === 1) {
      this.size = this.size - 1 | 0;
  ...
  TGenPriorityQueue.prototype.indexOf_11rb$ = function (element) {
    var tmp$;
    tmp$ = this.size;
    for (var n = 0; n < tmp$; n++) {
  ...
  TGenPriorityQueue.prototype.updateObject_11rb$ = function (element) {
    var index = this.indexOf_11rb$(element);
    if (index >= 0)
      this.updateAt_za3lpa$(index);
  };
  TGenPriorityQueue.prototype.updateAt_za3lpa$ = function (index) {
    var value = this.get_value_0(index);
    this.removeAt_za3lpa$(index);
    this.add_11rb$(value);
  };
  TGenPriorityQueue.prototype.remove_11rb$ = function (element) {
    var index = this.indexOf_11rb$(element);
    if (index >= 0)
      this.removeAt_za3lpa$(index);
    return index >= 0;
  };
  TGenPriorityQueue.prototype.removeAt_za3lpa$ = function (index) {
    var i = index;
    while (i !== 0) {
      this.swap_0(i, this.get_parent_0(i));
      i = this.get_parent_0(i);
  ...
  TGenPriorityQueue.prototype.swap_0 = function (l, r) {
    var temp = this.get_value_0(r);
    this.set_value_0(r, this.get_value_0(l));
    this.set_value_0(l, temp);
  };
  TGenPriorityQueue.prototype.contains_11rb$ = function (element) {
    var $receiver = until(0, this.size);
    var any$result;
    any$break: do {
      var tmp$;
  ...
  TGenPriorityQueue.prototype.containsAll_brywnq$ = function (elements) {
  ...
  TGenPriorityQueue.prototype.isEmpty = function () {
    return this.size === 0;
  };
  TGenPriorityQueue.prototype.addAll_brywnq$ = function (elements) {
    var tmp$;
    tmp$ = elements.iterator();
    while (tmp$.hasNext()) {
      var e = tmp$.next();
  ...
  TGenPriorityQueue.prototype.clear = function () {
    this.size = 0;
  };
  TGenPriorityQueue.prototype.removeAll_brywnq$ = function (elements) {
  ...
  TGenPriorityQueue.prototype.retainAll_brywnq$ = function (elements) {
    var temp = ArrayList_init_1(toList(this));
  ...
  function TGenPriorityQueue$iterator$ObjectLiteral(closure$index, this$TGenPriorityQueue) {
    this.closure$index = closure$index;
    this.this$TGenPriorityQueue = this$TGenPriorityQueue;
  }
  TGenPriorityQueue$iterator$ObjectLiteral.prototype.hasNext = function () {
    return this.closure$index.v < this.this$TGenPriorityQueue.size;
  };
  TGenPriorityQueue$iterator$ObjectLiteral.prototype.next = function () {
    var tmp$;
    return this.this$TGenPriorityQueue.get_value_0((tmp$ = this.closure$index.v, this.closure$index.v = tmp$ + 1 | 0, tmp$));
  };
  TGenPriorityQueue$iterator$ObjectLiteral.prototype.remove = function () {
    throw new NotImplementedError_init();
  };
  TGenPriorityQueue$iterator$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [MutableIterator]
  };
  TGenPriorityQueue.prototype.iterator = function () {
    var index = {v: 0};
    return new TGenPriorityQueue$iterator$ObjectLiteral(index, this);
  };
  TGenPriorityQueue.prototype.toArraySorted = function () {
    var tmp$, tmp$_0, tmp$_1;
  ...
  TGenPriorityQueue.prototype.equals = function (other) {
    return Kotlin.isType(other, TGenPriorityQueue) && contentEquals(this.data_0, other.data_0) && equals(this.comparator, other.comparator);
  };
  TGenPriorityQueue.prototype.hashCode = function () {
    return contentHashCode(this.data_0);
  };
  TGenPriorityQueue.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'TGenPriorityQueue',
    interfaces: [MutableCollection]
  };
  ...
  IntPriorityQueue.prototype.equals = function (other) {
    return Kotlin.isType(other, IntPriorityQueue) && contentEquals(this.data_0, other.data_0) && equals(this.comparator, other.comparator);
  };
  IntPriorityQueue.prototype.hashCode = function () {
    return contentHashCode(this.data_0);
  };
  ...
  DoublePriorityQueue.prototype.equals = function (other) {
    return Kotlin.isType(other, DoublePriorityQueue) && contentEquals(this.data_0, other.data_0) && equals(this.comparator, other.comparator);
  };
  DoublePriorityQueue.prototype.hashCode = function () {
    return contentHashCode(this.data_0);
  };
  ...
  FloatPriorityQueue.prototype.equals = function (other) {
    return Kotlin.isType(other, FloatPriorityQueue) && contentEquals(this.data_0, other.data_0) && equals(this.comparator, other.comparator);
  };
  FloatPriorityQueue.prototype.hashCode = function () {
    return contentHashCode(this.data_0);
  };
  ...
  function TGenQueue() {
    this.items_0 = TGenDeque_init();
  }
  Object.defineProperty(TGenQueue.prototype, 'size', {
    get: function () {
      return this.items_0.size;
    }
  });
  TGenQueue.prototype.isEmpty = function () {
    return this.size === 0;
  };
  TGenQueue.prototype.enqueue_11rb$ = function (v) {
    this.items_0.addLast_11rb$(v);
  };
  TGenQueue.prototype.peek = function () {
    return firstOrNull_0(this.items_0);
  };
  TGenQueue.prototype.dequeue = function () {
    return this.items_0.removeFirst();
  };
  TGenQueue.prototype.remove_11rb$ = function (v) {
    return this.items_0.remove_11rb$(v);
  };
  TGenQueue.prototype.toList = function () {
    return toList(this.items_0);
  };
  TGenQueue.prototype.clear = function () {
    this.items_0.clear();
  };
  TGenQueue.prototype.contains_11rb$ = function (element) {
    return this.items_0.contains_11rb$(element);
  };
  TGenQueue.prototype.containsAll_brywnq$ = function (elements) {
    return this.items_0.containsAll_brywnq$(elements);
  };
  TGenQueue.prototype.iterator = function () {
  ...
  TGenQueue.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, TGenQueue) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  TGenQueue.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'TGenQueue',
    interfaces: [Collection]
  };
  function TGenQueue_init(items, $this) {
    $this = $this || Object.create(TGenQueue.prototype);
    TGenQueue.call($this);
    var tmp$;
    for (tmp$ = 0; tmp$ !== items.length; ++tmp$) {
      var item = items[tmp$];
  ...
  IntQueue.prototype.peek = function () {
    return firstOrNull_0(this.items_0);
  };
  ...
  IntQueue.prototype.clear = function () {
    this.items_0.clear();
  };
  ...
  IntQueue.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  IntQueue.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, IntQueue) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  IntQueue.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'IntQueue',
  ...
  DoubleQueue.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  DoubleQueue.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, DoubleQueue) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  ...
  FloatQueue.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  FloatQueue.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, FloatQueue) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  FloatQueue.$metadata$ = {
    kind: Kind_CLASS,
  ...
  ByteRingBuffer.prototype.peek_za3lpa$ = function (offset) {
    if (offset === void 0)
      offset = 0;
    return this.buffer_8u4ary$_0[this.readPos_musy0$_0 + offset & this.mask_7w061q$_0];
  };
  ByteRingBuffer.prototype.equals = function (other) {
    var tmp$ = Kotlin.isType(other, ByteRingBuffer) && this.availableRead === other.availableRead;
    if (tmp$) {
      var count = this.availableRead;
      var equaler$result;
      equaler$break: do {
        for (var n = 0; n < count; n++) {
          if (!(this.peek_za3lpa$(n) === other.peek_za3lpa$(n))) {
            equaler$result = false;
            break equaler$break;
          }}
        equaler$result = true;
  ...
  ShortRingBuffer.prototype.peek_za3lpa$ = function (offset) {
    if (offset === void 0)
      offset = 0;
    return this.buffer_0[this.readPos_0 + offset & this.mask_0];
  };
  ShortRingBuffer.prototype.equals = function (other) {
    var tmp$ = Kotlin.isType(other, ShortRingBuffer) && this.availableRead === other.availableRead;
    if (tmp$) {
      var count = this.availableRead;
      var equaler$result;
      equaler$break: do {
  ...
  IntRingBuffer.prototype.peek_za3lpa$ = function (offset) {
    if (offset === void 0)
      offset = 0;
    return this.buffer_0[this.readPos_0 + offset & this.mask_0];
  };
  IntRingBuffer.prototype.equals = function (other) {
    var tmp$ = Kotlin.isType(other, IntRingBuffer) && this.availableRead === other.availableRead;
    if (tmp$) {
      var count = this.availableRead;
      var equaler$result;
      equaler$break: do {
  ...
  IntRingBuffer.prototype.hashCode = function () {
    var count = this.availableRead;
    var out = 0;
    for (var n = 0; n < count; n++) {
      out = out * 7 | 0;
  ...
  FloatRingBuffer.prototype.peek_za3lpa$ = function (offset) {
    if (offset === void 0)
      offset = 0;
    return this.buffer_0[this.readPos_0 + offset & this.mask_0];
  };
  FloatRingBuffer.prototype.equals = function (other) {
    var tmp$ = Kotlin.isType(other, FloatRingBuffer) && this.availableRead === other.availableRead;
    if (tmp$) {
      var count = this.availableRead;
      var equaler$result;
      equaler$break: do {
  ...
  FloatRingBuffer.prototype.hashCode = function () {
    ...
    for (var n = 0; n < count; n++) {
      out = out * 7 | 0;
      out = out + numberToInt(this.peek_za3lpa$(n)) | 0;
    }
    return out;
  };
  ...
  Object.defineProperty(TGenStack.prototype, 'size', {
    get: function () {
      return this.items_0.size;
    }
  });
  TGenStack.prototype.isEmpty = function () {
    return this.size === 0;
  };
  TGenStack.prototype.push_11rb$ = function (v) {
    return this.items_0.add_11rb$(v);
  };
  TGenStack.prototype.pop = function () {
    return this.items_0.removeAt_za3lpa$(this.items_0.size - 1 | 0);
  };
  TGenStack.prototype.peek = function () {
    return lastOrNull(this.items_0);
  };
  TGenStack.prototype.contains_11rb$ = function (element) {
    return this.items_0.contains_11rb$(element);
  };
  TGenStack.prototype.containsAll_brywnq$ = function (elements) {
    return this.items_0.containsAll_brywnq$(elements);
  };
  TGenStack.prototype.iterator = function () {
    return this.items_0.iterator();
  };
  TGenStack.prototype.hashCode = function () {
    return hashCode(this.items_0);
  };
  TGenStack.prototype.equals = function (other) {
    return Kotlin.isType(other, TGenStack) && equals(this.items_0, other.items_0);
  };
  TGenStack.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function TGenStack_init(items, $this) {
    $this = $this || Object.create(TGenStack.prototype);
    TGenStack.call($this);
    var tmp$;
    for (tmp$ = 0; tmp$ !== items.length; ++tmp$) {
      var item = items[tmp$];
  ...
  IntStack.prototype.peek = function () {
    return lastOrNull(this.items_0);
  };
  ...
  IntStack.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  IntStack.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, IntStack) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  IntStack.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'IntStack',
  ...
  DoubleStack.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  DoubleStack.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, DoubleStack) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  ...
  FloatStack.prototype.peek = function () {
    return lastOrNull(this.items_0);
  };
  ...
  FloatStack.prototype.hashCode = function () {
    return this.items_0.hashCode();
  };
  FloatStack.prototype.equals = function (other) {
    var tmp$;
    return Kotlin.isType(other, FloatStack) && ((tmp$ = this.items_0) != null ? tmp$.equals(other.items_0) : null);
  };
  FloatStack.$metadata$ = {
    kind: Kind_CLASS,
  ...
  var extraProperty = defineInlineFunction('kds-root-kds.com.soywiz.kds.extraProperty_1h9u2h$', wrapFunction(function () {
    var Extra$Extra$Property_init = _.com.soywiz.kds.Extra.Property;
    return function (name, default_0) {
      if (name === void 0)
        name = null;
      return new Extra$Extra$Property_init(name, default_0);
    };
  }));
  ...
  function Observable(initial, before, after) {
    if (before === void 0)
      before = Observable_init$lambda;
    if (after === void 0)
      after = Observable_init$lambda_0;
    this.initial = initial;
    this.before = before;
    this.after = after;
    this.currentValue = this.initial;
  }
  Observable.prototype.getValue_t0xcdd$ = function (obj, prop) {
    return this.currentValue;
  };
  Observable.prototype.setValue_cvomos$ = function (obj, prop, value) {
    this.before(value);
    this.currentValue = value;
    this.after(value);
  };
  function Observable_init$lambda(it) {
    return Unit;
  }
  function Observable_init$lambda_0(it) {
    return Unit;
  }
  Observable.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function getCyclic_1($receiver, index) {
    return $receiver.getAt_za3lpa$(umod(index, $receiver.size));
  }
  ...
  function binarySearch_2($receiver, v, fromIndex, toIndex) {
    ...
    genericBinarySearch$break: do {
      ...
      while (low <= high) {
        var mid = (low + high | 0) / 2 | 0;
        var mval = Kotlin.primitiveCompareTo($receiver.getAt_za3lpa$(mid), v);
        if (mval < 0)
          low = mid + 1 | 0;
        else if (mval > 0)
          high = mid - 1 | 0;
  ...
  function binarySearch_3($receiver, v, fromIndex, toIndex) {
    ...
    genericBinarySearch$break: do {
      ...
      while (low <= high) {
        var mid = (low + high | 0) / 2 | 0;
        var mval = Kotlin.compareTo($receiver.getAt_za3lpa$(mid), v);
        if (mval < 0)
          low = mid + 1 | 0;
        else if (mval > 0)
          high = mid - 1 | 0;
  ...
  function binarySearchLeft($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.length;
  ...
  function binarySearchLeft_0($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.length;
  ...
  function binarySearchLeft_1($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.length;
  ...
  function binarySearchLeft_2($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.size;
  ...
  function binarySearchLeft_3($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.size;
  ...
  function binarySearchLeft_4($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.size;
  ...
  function binarySearchRight($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.length;
  ...
  function binarySearchRight_0($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.length;
  ...
  function binarySearchRight_1($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.length;
  ...
  function binarySearchRight_2($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.size;
  ...
  function binarySearchRight_3($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.size;
  ...
  function binarySearchRight_4($receiver, v, fromIndex, toIndex) {
    if (fromIndex === void 0)
      fromIndex = 0;
    if (toIndex === void 0)
      toIndex = $receiver.size;
  ...
  var genericBinarySearchResult = defineInlineFunction('kds-root-kds.com.soywiz.kds.genericBinarySearchResult_51hkjm$', wrapFunction(function () {
    var BSearchResult_init = _.com.soywiz.kds.BSearchResult;
    return function (fromIndex, toIndex, check) {
      ...
      genericBinarySearch$break: do {
       ...
       while (false);
      return new BSearchResult_init(genericBinarySearch$result);
    };
  }));
  var genericBinarySearchLeft = defineInlineFunction('kds-root-kds.com.soywiz.kds.genericBinarySearchLeft_51hkjm$', wrapFunction(function () {
    var coerceIn = Kotlin.kotlin.ranges.coerceIn_e4yvb3$;
    var wrapFunction = Kotlin.wrapFunction;
    var Math_0 = Math;
    var genericBinarySearchLeft$lambda = wrapFunction(function () {
  ...
  var genericBinarySearchRight = defineInlineFunction('kds-root-kds.com.soywiz.kds.genericBinarySearchRight_51hkjm$', wrapFunction(function () {
    var coerceIn = Kotlin.kotlin.ranges.coerceIn_e4yvb3$;
    var wrapFunction = Kotlin.wrapFunction;
    var Math_0 = Math;
    var genericBinarySearchRight$lambda = wrapFunction(function () {
  ...
  var genericRemoveSortedDuplicates = defineInlineFunction('kds-root-kds.com.soywiz.kds.genericRemoveSortedDuplicates_r7citp$', function (size, equals, copy, resize) {
    if (size < 2)
      return;
    var pivot = 0;
    var ref = 0;
    while (true) {
      while (ref < size && equals(pivot, ref)) {
        ref = ref + 1 | 0;
      }
      if (ref >= size)
        break;
      copy(ref, (pivot = pivot + 1 | 0, pivot));
    }
    resize(pivot + 1 | 0);
  });
  function removeSortedDuplicates($receiver) {
    var size = $receiver.size;
    genericRemoveSortedDuplicates$break: do {
      if (size < 2)
        break genericRemoveSortedDuplicates$break;
      var pivot = 0;
      var ref = 0;
      while (true) {
        while (true) {
          ...
          if (tmp$) {
            var x = pivot;
            var y = ref;
            tmp$ = equals($receiver.get_za3lpa$(x), $receiver.get_za3lpa$(y));
          }if (!tmp$)
            break;
          ref = ref + 1 | 0;
        }
        if (ref >= size)
          break;
        var src = ref;
        $receiver.set_wxm5ur$((pivot = pivot + 1 | 0, pivot), $receiver.get_za3lpa$(src));
      }
      var size_0 = pivot + 1 | 0;
      while ($receiver.size > size_0 && size_0 >= 0)
        $receiver.removeAt_za3lpa$($receiver.size - 1 | 0);
    }
     while (false);
    return $receiver;
  }
  function withoutSortedDuplicates($receiver, out) {
    if (out === void 0) {
      out = ArrayList_init();
    }out.clear();
    out.addAll_brywnq$($receiver);
  ...
  function negateIf($receiver, doNegate) {
    return doNegate ? -$receiver | 0 : $receiver;
  }
  function insertionSort(arr, left, right, ops, reversed) {
    for (var n = left + 1 | 0; n <= right; n++) {
      var m = n - 1 | 0;
      while (m >= left && negateIf(ops.compare_8olpll$(arr, m, n), reversed) > 0) {
        m = m - 1 | 0;
      }
      m = m + 1 | 0;
      if (m !== n)
  ...
  function merge(arr, start, mid, end, ops, reversed) {
    ...
    var m = mid;
    var s2 = m + 1 | 0;
    if (negateIf(ops.compare_8olpll$(arr, m, s2), reversed) <= 0)
      return;
    while (s <= m && s2 <= end) {
      if (negateIf(ops.compare_8olpll$(arr, s, s2), reversed) <= 0) {
        s = s + 1 | 0;
      } else {
  ...
  function mergeSort(arr, l, r, ops, reversed) {
    if (l < r) {
      var m = l + ((r - l | 0) / 2 | 0) | 0;
      mergeSort(arr, l, m, ops, reversed);
      mergeSort(arr, m + 1 | 0, r, ops, reversed);
      merge(arr, l, m, r, ops, reversed);
    }}
  function timSort(arr, l, r, ops, reversed) {
    var tmp$;
    var RUN = 32;
    var n = r - l + 1 | 0;
    for (var i = 0; i < n; i += RUN) {
      ...
      var a = i + 31 | 0;
      var b = n - 1 | 0;
      insertionSort(arr, tmp$_0, l + Math_0.min(a, b) | 0, ops, reversed);
    }
    var size = RUN;
    while (size < n) {
      tmp$ = 2 * size | 0;
  ...
  SortOps.prototype.reverse_8olpll$ = function (subject, indexL, indexR) {
    var tmp$;
    var count = indexR - indexL + 1 | 0;
    tmp$ = count / 2 | 0;
    for (var n = 0; n < tmp$; n++) {
      this.swap_8olpll$(subject, indexL + n | 0, indexR - n | 0);
    }
  };
  SortOps.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function genericSort_1($receiver, left, right) {
    if (left === void 0)
      left = 0;
    if (right === void 0)
      right = $receiver.size - 1 | 0;
    var tmp$;
    return genericSort_0($receiver, left, right, Kotlin.isType(tmp$ = SortOpsComparable_getInstance(), SortOps) ? tmp$ : throwCCE(), false);
  }
  function genericSorted($receiver, left, right) {
    ...
    if (right === void 0)
      right = $receiver.size - 1 | 0;
    return genericSort_1(toMutableList($receiver.subList_vux9f0$(left, right + 1 | 0)));
  }
  function FakeMutableMap(map) {
    this.map = map;
    this.values_q2ps6c$_0 = asFakeMutable_1(this.map.values);
  }
  FakeMutableMap.prototype.clear = function () {
    throw new NotImplementedError_init();
  };
  FakeMutableMap.prototype.put_xwzc9p$ = function (key, value) {
    throw new NotImplementedError_init();
  };
  FakeMutableMap.prototype.putAll_a2k3zr$ = function (from) {
    throw new NotImplementedError_init();
  };
  FakeMutableMap.prototype.remove_11rb$ = function (key) {
    throw new NotImplementedError_init();
  };
  Object.defineProperty(FakeMutableMap.prototype, 'entries', {
    get: function () {
      return asFakeMutable_4(this.map.entries);
    }
  });
  Object.defineProperty(FakeMutableMap.prototype, 'keys', {
    get: function () {
      return asFakeMutable_0(this.map.keys);
    }
  });
  Object.defineProperty(FakeMutableMap.prototype, 'values', {
    get: function () {
      return this.values_q2ps6c$_0;
    }
  });
  Object.defineProperty(FakeMutableMap.prototype, 'size', {
    get: function () {
      return this.map.size;
    }
  });
  FakeMutableMap.prototype.containsKey_11rb$ = function (key) {
    return this.map.containsKey_11rb$(key);
  };
  FakeMutableMap.prototype.containsValue_11rc$ = function (value) {
    return this.map.containsValue_11rc$(value);
  };
  FakeMutableMap.prototype.get_11rb$ = function (key) {
    return this.map.get_11rb$(key);
  };
  FakeMutableMap.prototype.isEmpty = function () {
    return this.map.isEmpty();
  };
  FakeMutableMap.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableMap',
    interfaces: [MutableMap, Map_0]
  };
  function FakeMutableCollection(collection) {
    this.collection = collection;
  }
  FakeMutableCollection.prototype.add_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableCollection.prototype.addAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableCollection.prototype.clear = function () {
    throw new NotImplementedError_init();
  };
  FakeMutableCollection.prototype.remove_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableCollection.prototype.removeAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableCollection.prototype.retainAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableCollection.prototype.iterator = function () {
    return asFakeMutable_2(this.collection.iterator());
  };
  Object.defineProperty(FakeMutableCollection.prototype, 'size', {
    get: function () {
      return this.collection.size;
    }
  });
  FakeMutableCollection.prototype.contains_11rb$ = function (element) {
    return this.collection.contains_11rb$(element);
  };
  FakeMutableCollection.prototype.containsAll_brywnq$ = function (elements) {
    return this.collection.containsAll_brywnq$(elements);
  };
  FakeMutableCollection.prototype.isEmpty = function () {
    return this.collection.isEmpty();
  };
  FakeMutableCollection.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableCollection',
    interfaces: [MutableCollection, Collection]
  };
  function FakeMutableSet(set) {
    this.set = set;
  }
  FakeMutableSet.prototype.add_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableSet.prototype.addAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableSet.prototype.clear = function () {
    throw new NotImplementedError_init();
  };
  FakeMutableSet.prototype.remove_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableSet.prototype.removeAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableSet.prototype.retainAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableSet.prototype.iterator = function () {
    return asFakeMutable_2(this.set.iterator());
  };
  Object.defineProperty(FakeMutableSet.prototype, 'size', {
    get: function () {
      return this.set.size;
    }
  });
  FakeMutableSet.prototype.contains_11rb$ = function (element) {
    return this.set.contains_11rb$(element);
  };
  FakeMutableSet.prototype.containsAll_brywnq$ = function (elements) {
    return this.set.containsAll_brywnq$(elements);
  };
  FakeMutableSet.prototype.isEmpty = function () {
    return this.set.isEmpty();
  };
  FakeMutableSet.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableSet',
    interfaces: [MutableSet, Set]
  };
  function FakeMutableMapEntry(entry) {
    this.entry = entry;
  }
  Object.defineProperty(FakeMutableMapEntry.prototype, 'key', {
    get: function () {
      return this.entry.key;
    }
  });
  Object.defineProperty(FakeMutableMapEntry.prototype, 'value', {
    get: function () {
      return this.entry.value;
    }
  });
  FakeMutableMapEntry.prototype.setValue_11rc$ = function (newValue) {
    throw new NotImplementedError_init();
  };
  FakeMutableMapEntry.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableMapEntry',
    interfaces: [MutableMap$MutableEntry]
  };
  function FakeMutableSetMapEntry(set) {
    this.set = set;
  }
  FakeMutableSetMapEntry.prototype.add_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableSetMapEntry.prototype.addAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableSetMapEntry.prototype.clear = function () {
    throw new NotImplementedError_init();
  };
  FakeMutableSetMapEntry.prototype.iterator = function () {
    ...
    while (tmp$.hasNext()) {
      var item = tmp$.next();
      destination.add_11rb$(new FakeMutableMapEntry(item));
    }
    return asFakeMutable_2(destination.iterator());
  };
  FakeMutableSetMapEntry.prototype.remove_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableSetMapEntry.prototype.removeAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  FakeMutableSetMapEntry.prototype.retainAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init();
  };
  Object.defineProperty(FakeMutableSetMapEntry.prototype, 'size', {
    get: function () {
      return this.set.size;
    }
  });
  FakeMutableSetMapEntry.prototype.contains_11rb$ = function (element) {
    return this.set.contains_11rb$(element);
  };
  FakeMutableSetMapEntry.prototype.containsAll_brywnq$ = function (elements) {
    return this.set.containsAll_brywnq$(elements);
  };
  FakeMutableSetMapEntry.prototype.isEmpty = function () {
    return this.set.isEmpty();
  };
  FakeMutableSetMapEntry.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableSetMapEntry',
    interfaces: [MutableSet]
  };
  function FakeMutableIterator(iterator) {
    this.iterator = iterator;
  }
  FakeMutableIterator.prototype.remove = function () {
    throw new NotImplementedError_init();
  };
  FakeMutableIterator.prototype.hasNext = function () {
    return this.iterator.hasNext();
  };
  FakeMutableIterator.prototype.next = function () {
    return this.iterator.next();
  };
  FakeMutableIterator.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableIterator',
    interfaces: [MutableIterator, Iterator]
  };
  function FakeMutableListIterator(iterator) {
    this.iterator = iterator;
  }
  FakeMutableListIterator.prototype.add_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableListIterator.prototype.remove = function () {
    throw new NotImplementedError_init();
  };
  FakeMutableListIterator.prototype.set_11rb$ = function (element) {
    throw new NotImplementedError_init();
  };
  FakeMutableListIterator.prototype.hasNext = function () {
    return this.iterator.hasNext();
  };
  FakeMutableListIterator.prototype.hasPrevious = function () {
    return this.iterator.hasPrevious();
  };
  FakeMutableListIterator.prototype.next = function () {
    return this.iterator.next();
  };
  FakeMutableListIterator.prototype.nextIndex = function () {
    return this.iterator.nextIndex();
  };
  FakeMutableListIterator.prototype.previous = function () {
    return this.iterator.previous();
  };
  FakeMutableListIterator.prototype.previousIndex = function () {
    return this.iterator.previousIndex();
  };
  FakeMutableListIterator.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FakeMutableListIterator',
    interfaces: [MutableListIterator, ListIterator]
  };
  function asFakeMutable($receiver) {
    return new FakeMutableMap($receiver);
  }
  function asFakeMutable_0($receiver) {
    return new FakeMutableSet($receiver);
  }
  function asFakeMutable_1($receiver) {
    return new FakeMutableCollection($receiver);
  }
  function asFakeMutable_2($receiver) {
    return new FakeMutableIterator($receiver);
  }
  function asFakeMutable_3($receiver) {
    return new FakeMutableListIterator($receiver);
  }
  function asFakeMutable_4($receiver) {
    return new FakeMutableSetMapEntry($receiver);
  }
  ...
  var hashCoder = defineInlineFunction('kds-root-kds.com.soywiz.kds.internal.hashCoder_rc80j3$', function (count, gen) {
    var out = 0;
    for (var n = 0; n < count; n++) {
      out = out * 7 | 0;
      out = out + gen(n) | 0;
  ...
  var equaler = defineInlineFunction('kds-root-kds.com.soywiz.kds.internal.equaler_j64m2w$', function (count, gen) {
    for (var n = 0; n < count; n++)
      if (!gen(n))
        return false;
    return true;
  ...
  var fastForEach_4 = defineInlineFunction('kds-root-kds.com.soywiz.kds.iterators.fastForEach_70nuq0$', function ($receiver, callback) {
    var tmp$;
    var n = 0;
    while (n < $receiver.size) {
      callback($receiver.getAt_za3lpa$((tmp$ = n, n = tmp$ + 1 | 0, tmp$)));
    }
  });
  var fastForEach_5 = defineInlineFunction('kds-root-kds.com.soywiz.kds.iterators.fastForEach_e754wu$', function ($receiver, callback) {
    var tmp$;
    var n = 0;
    while (n < $receiver.size) {
      callback($receiver.getAt_za3lpa$((tmp$ = n, n = tmp$ + 1 | 0, tmp$)));
  ...
  var fastForEach_6 = defineInlineFunction('kds-root-kds.com.soywiz.kds.iterators.fastForEach_q6y056$', function ($receiver, callback) {
    var tmp$;
    var n = 0;
    while (n < $receiver.size) {
      callback($receiver.getAt_za3lpa$((tmp$ = n, n = tmp$ + 1 | 0, tmp$)));
  ...
  var fastForEachWithIndex_1 = defineInlineFunction('kds-root-kds.com.soywiz.kds.iterators.fastForEachWithIndex_b77gno$', function ($receiver, callback) {
    var n = 0;
    while (n < $receiver.size) {
      callback(n, $receiver.getAt_za3lpa$(n));
      n = n + 1 | 0;
    }
  });
  var fastForEachWithIndex_2 = defineInlineFunction('kds-root-kds.com.soywiz.kds.iterators.fastForEachWithIndex_y68anu$', function ($receiver, callback) {
    var n = 0;
    while (n < $receiver.size) {
      callback(n, $receiver.getAt_za3lpa$(n));
      n = n + 1 | 0;
  ...
  var fastForEachWithIndex_3 = defineInlineFunction('kds-root-kds.com.soywiz.kds.iterators.fastForEachWithIndex_bfe0a2$', function ($receiver, callback) {
    var n = 0;
    while (n < $receiver.size) {
      callback(n, $receiver.getAt_za3lpa$(n));
      n = n + 1 | 0;
  ...
  function SubMutableList(list, start, end) {
    this.list = list;
    this.start = start;
    this.end = end;
  }
  Object.defineProperty(SubMutableList.prototype, 'size', {
    get: function () {
      return this.end - this.start | 0;
    }
  });
  SubMutableList.prototype.contains_11rb$ = function (element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.containsAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.get_za3lpa$ = function (index) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.indexOf_11rb$ = function (element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.isEmpty = function () {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.iterator = function () {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.lastIndexOf_11rb$ = function (element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.add_11rb$ = function (element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.add_wxm5ur$ = function (index, element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.addAll_u57x28$ = function (index, elements) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.addAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.clear = function () {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.listIterator = function () {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.listIterator_za3lpa$ = function (index) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.remove_11rb$ = function (element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.removeAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.removeAt_za3lpa$ = function (index) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.retainAll_brywnq$ = function (elements) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.set_wxm5ur$ = function (index, element) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.prototype.subList_vux9f0$ = function (fromIndex, toIndex) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not yet implemented');
  };
  SubMutableList.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'SubMutableList',
    interfaces: [MutableList]
  };
  ...
  function KdsAtomicRef(initial) {
    this.value = initial;
  }
  KdsAtomicRef.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'KdsAtomicRef',
    interfaces: []
  };
  function kdsFreeze($receiver) {
    return $receiver;
  }
  function get_kdsIsFrozen($receiver) {
    return false;
  }
  function kdsEnsureNeverFrozen($receiver) {
  }
  ...
  Object.defineProperty(IntArrayList, 'Companion', {
    get: IntArrayList$Companion_getInstance
  });
  ...
  Object.defineProperty(DoubleArrayList, 'Companion', {
    get: DoubleArrayList$Companion_getInstance
  });
  ...
  Object.defineProperty(FloatArrayList, 'Companion', {
    get: FloatArrayList$Companion_getInstance
  });
  ...
  package$kds.sort_jbn2zs$ = sort;
  package$kds.sort_y4a3oy$ = sort_0;
  package$kds.sort_69zlbv$ = sort_1;
  package$kds.reverse_nqug1d$ = reverse;
  package$kds.reverse_moloih$ = reverse_0;
  package$kds.reverse_9fwvk2$ = reverse_1;
  ...
  package$kds.CopyOnWriteFrozenList = CopyOnWriteFrozenList;
  package$kds.CopyOnWriteFrozenMap = CopyOnWriteFrozenMap;
  package$kds.CopyOnWriteFrozenSet = CopyOnWriteFrozenSet;
  package$kds.TGenDeque_init_287e2$ = TGenDeque_init;
  package$kds.TGenDeque = TGenDeque;
  package$kds.IntDeque_init = IntDeque_init;
  package$kds.IntDeque = IntDeque;
  package$kds.DoubleDeque_init = DoubleDeque_init;
  package$kds.DoubleDeque = DoubleDeque;
  package$kds.FloatDeque_init = FloatDeque_init;
  package$kds.FloatDeque = FloatDeque;
  package$kds.ByteDeque_init = ByteDeque_init;
  ...
  Object.defineProperty(TGenPriorityQueue, 'Companion', {
    get: TGenPriorityQueue$Companion_getInstance
  });
  package$kds.TGenPriorityQueue = TGenPriorityQueue;
  ...
  package$kds.TGenQueue_init_i5x0yv$ = TGenQueue_init;
  package$kds.TGenQueue = TGenQueue;
  ...
  package$kds.TGenStack_init_i5x0yv$ = TGenStack_init;
  package$kds.TGenStack = TGenStack;
  ...
  package$kds.extraProperty_1h9u2h$ = extraProperty;
  ...
  package$kds.Observable = Observable;
  ...
  package$kds.binarySearchLeft_tpuxuu$ = binarySearchLeft;
  package$kds.binarySearchLeft_nwy378$ = binarySearchLeft_0;
  package$kds.binarySearchLeft_x4f2cq$ = binarySearchLeft_1;
  package$kds.binarySearchLeft_aunrz$ = binarySearchLeft_2;
  package$kds.binarySearchLeft_3m9gjr$ = binarySearchLeft_3;
  package$kds.binarySearchLeft_gadt63$ = binarySearchLeft_4;
  package$kds.binarySearchRight_tpuxuu$ = binarySearchRight;
  package$kds.binarySearchRight_nwy378$ = binarySearchRight_0;
  package$kds.binarySearchRight_x4f2cq$ = binarySearchRight_1;
  package$kds.binarySearchRight_aunrz$ = binarySearchRight_2;
  package$kds.binarySearchRight_3m9gjr$ = binarySearchRight_3;
  package$kds.binarySearchRight_gadt63$ = binarySearchRight_4;
  package$kds.genericBinarySearch_fz6bok$ = genericBinarySearch;
  package$kds.genericBinarySearchResult_51hkjm$ = genericBinarySearchResult;
  package$kds.genericBinarySearchLeft_51hkjm$ = genericBinarySearchLeft;
  package$kds.genericBinarySearchRight_51hkjm$ = genericBinarySearchRight;
  package$kds.BSearchResult = BSearchResult;
  package$kds.genericRemoveSortedDuplicates_r7citp$ = genericRemoveSortedDuplicates;
  package$kds.removeSortedDuplicates_xqced2$ = removeSortedDuplicates;
  package$kds.withoutSortedDuplicates_l6b90p$ = withoutSortedDuplicates;
  package$kds.genericSort_bepgem$ = genericSort;
  package$kds.genericSort_yb8mvh$ = genericSort_0;
  package$kds.SortOps = SortOps;
  Object.defineProperty(package$kds, 'SortOpsComparable', {
    get: SortOpsComparable_getInstance
  });
  package$kds.genericSort_pjmrmz$ = genericSort_1;
  package$kds.genericSorted_adeaps$ = genericSorted;
  var package$fakemutable = package$kds.fakemutable || (package$kds.fakemutable = {});
  package$fakemutable.FakeMutableMap = FakeMutableMap;
  package$fakemutable.FakeMutableCollection = FakeMutableCollection;
  package$fakemutable.FakeMutableSet = FakeMutableSet;
  package$fakemutable.FakeMutableMapEntry = FakeMutableMapEntry;
  package$fakemutable.FakeMutableSetMapEntry = FakeMutableSetMapEntry;
  package$fakemutable.FakeMutableIterator = FakeMutableIterator;
  package$fakemutable.FakeMutableListIterator = FakeMutableListIterator;
  package$fakemutable.asFakeMutable_go3l1a$ = asFakeMutable;
  package$fakemutable.asFakeMutable_cgavii$ = asFakeMutable_0;
  package$fakemutable.asFakeMutable_4c7yge$ = asFakeMutable_1;
  package$fakemutable.asFakeMutable_35ci02$ = asFakeMutable_2;
  package$fakemutable.asFakeMutable_qrx9pc$ = asFakeMutable_3;
  package$fakemutable.asFakeMutable_7p2f7m$ = asFakeMutable_4;
  ...
  package$internal.hashCoder_rc80j3$ = hashCoder;
  package$internal.equaler_j64m2w$ = equaler;
  ...
  package$iterators.fastForEach_70nuq0$ = fastForEach_4;
  package$iterators.fastForEach_e754wu$ = fastForEach_5;
  package$iterators.fastForEach_q6y056$ = fastForEach_6;
  ...
  package$iterators.fastForEachWithIndex_b77gno$ = fastForEachWithIndex_1;
  package$iterators.fastForEachWithIndex_y68anu$ = fastForEachWithIndex_2;
  package$iterators.fastForEachWithIndex_bfe0a2$ = fastForEachWithIndex_3;
  ...
  var package$sub = package$kds.sub || (package$kds.sub = {});
  package$sub.SubMutableList = SubMutableList;
  ...
  var package$atomic = package$kds.atomic || (package$kds.atomic = {});
  package$atomic.KdsAtomicRef = KdsAtomicRef;
  package$atomic.kdsFreeze_eoe559$ = kdsFreeze;
  package$atomic.get_kdsIsFrozen_vvk9$ = get_kdsIsFrozen;
  package$atomic.kdsEnsureNeverFrozen_s8jyvk$ = kdsEnsureNeverFrozen;
