(function (root, factory) {
  ...
  LogBaseAG.prototype = Object.create(AG.prototype);
  LogBaseAG.prototype.constructor = LogBaseAG;
  LogAG.prototype = Object.create(LogBaseAG.prototype);
  LogAG.prototype.constructor = LogAG;
  LogBaseAG$LogTexture.prototype = Object.create(AG$Texture.prototype);
  LogBaseAG$LogTexture.prototype.constructor = LogBaseAG$LogTexture;
  LogBaseAG$LogBuffer.prototype = Object.create(AG$Buffer.prototype);
  LogBaseAG$LogBuffer.prototype.constructor = LogBaseAG$LogBuffer;
  LogBaseAG$LogRenderBuffer.prototype = Object.create(AG$RenderBuffer.prototype);
  LogBaseAG$LogRenderBuffer.prototype.constructor = LogBaseAG$LogRenderBuffer;
  ...
  function checked($receiver, throwException) {
    if (throwException === void 0)
      throwException = false;
    return new CheckErrorsKmlGlProxy($receiver, throwException);
  }
  function checkedIf($receiver, checked, throwException) {
    if (throwException === void 0)
      throwException = false;
    return checked ? new CheckErrorsKmlGlProxy($receiver, throwException) : $receiver;
  }
  ...
  AG$BaseRenderBuffer.prototype.unset = function () {
  };
  ...
  AG.prototype.setRenderBuffer_m67x29$ = function (renderBuffer) {
    ...
    this.currentRenderBuffer.unset();
    this.currentRenderBuffer = renderBuffer;
    renderBuffer.set();
    return old;
  };
  AG.prototype.unsetBackBuffer_vux9f0$ = function (width, height) {
  };
  ...
  AG$mainRenderBuffer$ObjectLiteral.prototype.unset = function () {
    this.this$AG.unsetBackBuffer_vux9f0$(this.width, this.height);
  };
  ...
  ForcedTexId.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'ForcedTexId',
    interfaces: []
  };
  function ForcedTexTarget() {
  }
  ForcedTexTarget.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'ForcedTexTarget',
    interfaces: []
  };
  function AGOpengl() {
    AG.call(this);
    ...
    this.android_buyc4s$_0 = false;
    this.webgl_qtlfii$_0 = false;
    this.devicePixelRatio_n8znee$_0 = 1.0;
    this.backBufferTextureBinding2d = 0;
    this.backBufferRenderBufferBinding = 0;
    this.backBufferFrameBufferBinding = 0;
    ...
    this.tempBufferM2 = FBuffer.Companion.allocUnaligned_za3lpa$(16);
    this.tempBufferM3 = FBuffer.Companion.allocUnaligned_za3lpa$(36);
    this.tempBufferM4 = FBuffer.Companion.allocUnaligned_za3lpa$(64);
  ...
  Object.defineProperty(AGOpengl.prototype, 'android', {
    get: function () {
      return this.android_buyc4s$_0;
    }
  });
  ...
  AGOpengl.prototype.unsetBackBuffer_vux9f0$ = function (width, height) {
    this.backBufferTextureBinding2d = getIntegerv(this.gl, this.gl.TEXTURE_BINDING_2D);
    this.backBufferRenderBufferBinding = getIntegerv(this.gl, this.gl.RENDERBUFFER_BINDING);
    this.backBufferFrameBufferBinding = getIntegerv(this.gl, this.gl.FRAMEBUFFER_BINDING);
  };
  AGOpengl.prototype.setBackBuffer_vux9f0$ = function (width, height) {
    this.gl.bindTexture_vux9f0$(this.gl.TEXTURE_2D, this.backBufferTextureBinding2d);
    this.gl.bindRenderbuffer_vux9f0$(this.gl.RENDERBUFFER, this.backBufferRenderBufferBinding);
    this.gl.bindFramebuffer_vux9f0$(this.gl.FRAMEBUFFER, this.backBufferFrameBufferBinding);
    this.setViewport_tjonv8$(0, 0, width, height);
  };
  ...
  AGOpengl.prototype.draw_y6md32$ = function (batch) {
    ...
    tmp$ = uniforms.uniforms.size;
    for (var n = 0; n < tmp$; n++) {
      var uniform = uniforms.uniforms.get_za3lpa$(n);
      var uniformType = uniform.type;
      var value = uniforms.values.get_za3lpa$(n);
      if (equals(uniformType, VarType$TextureUnit_getInstance())) {
        var unit = Kotlin.isType(tmp$_0 = value, AG$TextureUnit) ? tmp$_0 : throwCCE();
        var tex = (tmp$_1 = unit.texture) == null || Kotlin.isType(tmp$_1, AGOpengl$GlTexture) ? tmp$_1 : throwCCE();
        if (tex != null) {
          if (tex.forcedTexTarget !== this.gl.TEXTURE_2D && tex.forcedTexTarget !== -1) {
            useExternalSampler = true;
          }}}}
    this.checkBuffers_p517yr$(vertices, indices);
    var programConfig = useExternalSampler ? ProgramConfig$Companion_getInstance().EXTERNAL_TEXTURE_SAMPLER : ProgramConfig$Companion_getInstance().DEFAULT;
    var glProgram = this.getProgram_gpl6to$(program, programConfig);
    (Kotlin.isType(tmp$_2 = vertices, AGOpengl$GlBuffer) ? tmp$_2 : throwCCE()).bind_jm7esb$(this.gl);
    (tmp$_4 = (tmp$_3 = indices) == null || Kotlin.isType(tmp$_3, AGOpengl$GlBuffer) ? tmp$_3 : null) != null ? (tmp$_4.bind_jm7esb$(this.gl), Unit) : null;
    glProgram.use();
    var totalSize = vertexLayout.totalSize;
    tmp$_5 = vattrspos.size;
    for (var n_0 = 0; n_0 < tmp$_5; n_0++) {
      var att = vattrs.get_za3lpa$(n_0);
      if (att.active) {
        var off = vattrspos.get_za3lpa$(n_0);
    ...
    var textureUnit = 0;
    tmp$_6 = uniforms.uniforms.size;
    for (var n_1 = 0; n_1 < tmp$_6; n_1++) {
      var uniform_0 = uniforms.uniforms.get_za3lpa$(n_1);
      var uniformName = uniform_0.name;
      var uniformType_0 = uniform_0.type;
      var value_0 = uniforms.values.get_za3lpa$(n_1);
      var location = this.gl.getUniformLocation_19mbxw$(glProgram.id, uniformName);
      var declArrayCount = uniform_0.arrayCount;
      var stride = uniform_0.type.elementCount;
      switch (uniformType_0.name) {
        case 'TextureUnit':
          var unit_0 = Kotlin.isType(tmp$_7 = value_0, AG$TextureUnit) ? tmp$_7 : throwCCE();
          this.gl.activeTexture_za3lpa$(this.gl.TEXTURE0 + textureUnit | 0);
          var tex_0 = (tmp$_8 = unit_0.texture) == null || Kotlin.isType(tmp$_8, AGOpengl$GlTexture) ? tmp$_8 : throwCCE();
          tex_0 != null ? (tex_0.bindEnsuring(), Unit) : null;
          tex_0 != null ? (tex_0.setFilter_6taknv$(unit_0.linear), Unit) : null;
        ...
        case 'Mat3':
        case 'Mat4':
          if (Kotlin.isArray(value_0))
            tmp$_9 = value_0;
          else if (Kotlin.isType(value_0, Matrix3D)) {
            var $receiver = this.mat3dArray_qu1n07$_0;
            $receiver[0].copyFrom_p62hku$(value_0);
            tmp$_9 = $receiver;
          } else {
            throw IllegalStateException_init('Not an array or a matrix3d'.toString());
          }

          var matArray = Kotlin.isArray(tmp$_10 = tmp$_9) ? tmp$_10 : throwCCE();
          ...
          for (var n_2 = 0; n_2 < arrayCount; n_2++) {
            copyToFloatWxH(matArray[n_2], this.tempFloats_kzvmdi$_0, matSize, matSize, MajorOrder.COLUMN, Kotlin.imul(n_2, stride));
          }
          ...
          if (this.webgl) {
            switch (uniformType_0.name) {
              case 'Mat2':
                tmp$_12 = this.tempBufferM2;
                break;
              case 'Mat3':
                tmp$_12 = this.tempBufferM3;
                break;
              case 'Mat4':
                tmp$_12 = this.tempBufferM4;
                break;
              default:tmp$_12 = this.tempBufferM4;
                break;
            }
            var tb = tmp$_12;
            for (var n_3 = 0; n_3 < arrayCount; n_3++) {
              var itLocation = arrayCount === 1 ? location : this.gl.getUniformLocation_19mbxw$(glProgram.id, uniform_0.indexNames[n_3]);
              arraycopy(this.tempBuffer.arrayFloat, Kotlin.imul(n_3, stride), tb.arrayFloat, 0, stride);
              switch (uniform_0.type.name) {
                case 'Mat2':
                ...
                case 'Mat4':
                  ...
                  break;
                default:invalidOp("Don't know how to set uniform matrix " + uniform_0.type);
                  break;
              }
            }
          } else {
        ...
        case 'Float4':
          ...
          if (Kotlin.isNumber(value_0))
            this.tempBuffer.setAlignedFloat32_24o109$(0, numberToDouble(value_0));
          else if (Kotlin.isType(value_0, Vector3D))
            setFloats(this.tempBuffer, 0, value_0.data, 0, stride);
          else if (Kotlin.isFloatArray(value_0)) {
            var b = value_0.length / stride | 0;
            arrayCount_0 = Math_0.min(declArrayCount, b);
            setFloats(this.tempBuffer, 0, value_0, 0, Kotlin.imul(stride, arrayCount_0));
          } else if (Kotlin.isArray(value_0)) {
            arrayCount_0 = Math_0.min(declArrayCount, value_0.length);
            for (var n_4 = 0; n_4 < value_0.length; n_4++) {
              var vector = Kotlin.isType(tmp$_13 = value_0[n_4], Vector3D) ? tmp$_13 : throwCCE();
              setFloats(this.tempBuffer, Kotlin.imul(n_4, stride), vector.data, 0, stride);
            }
          } else {
            throw IllegalStateException_init(("Unknown type '" + value_0.toString() + "'").toString());
          }

          if (this.webgl) {
            var tb_0 = this.tempBufferM2;
            tmp$_14 = arrayCount_0;
            for (var n_5 = 0; n_5 < tmp$_14; n_5++) {
              var itLocation_0 = arrayCount_0 === 1 ? location : this.gl.getUniformLocation_19mbxw$(glProgram.id, uniform_0.indexNames[n_5]);
          ...
          break;
        default:invalidOp("Don't know how to set uniform " + uniform_0.type);
          break;
      }
    }
    if (blending.enabled) {
    ...
    tmp$_15 = vattrs.size;
    for (var n_6 = 0; n_6 < tmp$_15; n_6++) {
      var att_0 = vattrs.get_za3lpa$(n_6);
      if (att_0.active) {
  ...
  AGOpengl.prototype.getProgram_gpl6to$ = function (program, config) {
    if (config === void 0)
      config = ProgramConfig$Companion_getInstance().DEFAULT;
    ...
    var $receiver_0 = tmp$;
    var tmp$_0;
    var value_0 = $receiver_0.get_11rb$(config);
    if (value_0 == null) {
      var answer_0 = new AGOpengl$GlProgram(this, this.gl, program, config);
      $receiver_0.put_xwzc9p$(config, answer_0);
      tmp$_0 = answer_0;
    } else {
      tmp$_0 = value_0;
    }
  ...
  function AGOpengl$GlProgram($outer, gl, program, programConfig) {
    this.$outer = $outer;
    this.gl = gl;
    this.program = program;
  ...
  AGOpengl$GlProgram.prototype.ensure_0 = function () {
    ...
    if (this.cachedVersion !== this.$outer.contextVersion) {
      ...
      try {
        var this$AGOpengl = this.$outer;
        tmp$_3 = this.createShader_0(type, toNewGlslStringResult_0(this.program.fragment, new GlslConfig(this$AGOpengl.gles, usedGlSlVersion, true, this$AGOpengl.android, this.programConfig)).result);
      } catch (e) {
        if (Kotlin.isType(e, AGOpengl$ShaderException)) {
          var this$AGOpengl_0 = this.$outer;
          tmp$_3 = this.createShader_0(type, toNewGlslStringResult_0(this.program.fragment, new GlslConfig(this$AGOpengl_0.gles, usedGlSlVersion, false, this$AGOpengl_0.android, this.programConfig)).result);
        } else
          throw e;
      }
      ...
      try {
        ...
        tmp$_4 = this.createShader_0(type_0, toNewGlslStringResult_0(this.program.vertex, new GlslConfig(this$AGOpengl_1.gles, usedGlSlVersion, true, this$AGOpengl_1.android, this.programConfig)).result);
      } catch (e_0) {
        if (Kotlin.isType(e_0, AGOpengl$ShaderException)) {
          var this$AGOpengl_2 = this.$outer;
          tmp$_4 = this.createShader_0(type_0, toNewGlslStringResult_0(this.program.vertex, new GlslConfig(this$AGOpengl_2.gles, usedGlSlVersion, false, this$AGOpengl_2.android, this.programConfig)).result);
        } else
          throw e_0;
      }
  ...
  function AGOpengl$GlTexture($outer, gl, premultiplied) {
    ...
    this.forcedTexId = -1;
    this.forcedTexTarget = this.gl.TEXTURE_2D;
    this.closed_0 = false;
  }
  ...
  AGOpengl$GlTexture.prototype.actualSyncUpload_u9zjc3$ = function (source, bmp, requestMipmaps) {
    ...
    var type = tmp$;
    if (Kotlin.isType(bmp, ForcedTexId)) {
      this.forcedTexId = bmp.forcedTexId;
      if (Kotlin.isType(bmp, ForcedTexTarget))
        this.forcedTexTarget = bmp.forcedTexTarget;
      return;
    } else if (Kotlin.isType(bmp, NativeImage)) {
      if (bmp.forcedTexId !== -1) {
        this.forcedTexId = bmp.forcedTexId;
        if (bmp.forcedTexTarget !== -1)
          this.forcedTexTarget = bmp.forcedTexTarget;
        return;
      }this.$outer.prepareUploadNativeTexture_m8r6i1$(bmp);
      if (bmp.area !== 0) {
        this.gl.texImage2D_gqqctv$(this.forcedTexTarget, 0, type, type, this.gl.UNSIGNED_BYTE, bmp);
      }} else {
      var buffer = this.createBufferForBitmap_p18la5$(bmp);
      if (buffer != null && source.width !== 0 && source.height !== 0 && buffer.size !== 0) {
        this.gl.texImage2D_byudfd$(this.forcedTexTarget, 0, type, source.width, source.height, 0, type, this.gl.UNSIGNED_BYTE, buffer);
      }}
    if (requestMipmaps && get_isPowerOfTwo(source.width) && get_isPowerOfTwo(source.height)) {
      ...
      this.setWrapST_0();
      this.gl.generateMipmap_za3lpa$(this.forcedTexTarget);
    }};
  AGOpengl$GlTexture.prototype.bind = function () {
    this.gl.bindTexture_vux9f0$(this.forcedTexTarget, this.tex);
  };
  AGOpengl$GlTexture.prototype.unbind = function () {
    this.gl.bindTexture_vux9f0$(this.forcedTexTarget, 0);
  };
  ...
  AGOpengl$GlTexture.prototype.setWrapST_0 = function () {
    this.gl.texParameteri_qt1dr2$(this.forcedTexTarget, this.gl.TEXTURE_WRAP_S, this.gl.CLAMP_TO_EDGE);
    this.gl.texParameteri_qt1dr2$(this.forcedTexTarget, this.gl.TEXTURE_WRAP_T, this.gl.CLAMP_TO_EDGE);
  };
  AGOpengl$GlTexture.prototype.setMinMag_0 = function (min, mag) {
    this.gl.texParameteri_qt1dr2$(this.forcedTexTarget, this.gl.TEXTURE_MIN_FILTER, min);
    this.gl.texParameteri_qt1dr2$(this.forcedTexTarget, this.gl.TEXTURE_MAG_FILTER, mag);
  };
  ...
  function LogBaseAG(width, height) {
    ...
    if (height === void 0)
      height = 480;
    AG.call(this);
    this.nativeComponent_n98uv3$_0 = new Any();
    this.ready();
    this.backWidth_5s60bs$_0 = width;
    this.backHeight_saoarj$_0 = height;
    this.textureId_b6t5ld$_0 = 0;
    this.bufferId_ms97wy$_0 = 0;
    this.renderBufferId_s27xuk$_0 = 0;
  }
  Object.defineProperty(LogBaseAG.prototype, 'nativeComponent', {
    get: function () {
      return this.nativeComponent_n98uv3$_0;
    }
  });
  LogBaseAG.prototype.log_61zpoe$ = function (str) {
  };
  LogBaseAG.prototype.clear_yvqa77$$default = function (color, depth, stencil, clearColor, clearDepth, clearStencil) {
    this.log_61zpoe$('clear(' + color + ', ' + depth + ', ' + stencil + ', ' + clearColor + ', ' + clearDepth + ', ' + clearStencil + ')');
  };
  Object.defineProperty(LogBaseAG.prototype, 'backWidth', {
    get: function () {
      return this.backWidth_5s60bs$_0;
    },
    set: function (value) {
      this.backWidth_5s60bs$_0 = value;
      this.log_61zpoe$('backWidth = ' + value);
    }
  });
  Object.defineProperty(LogBaseAG.prototype, 'backHeight', {
    get: function () {
      return this.backHeight_saoarj$_0;
    },
    set: function (value) {
      this.backHeight_saoarj$_0 = value;
      this.log_61zpoe$('backHeight = ' + value);
    }
  });
  LogBaseAG.prototype.repaint = function () {
    this.log_61zpoe$('repaint()');
  };
  LogBaseAG.prototype.dispose = function () {
    this.log_61zpoe$('dispose()');
  };
  function LogBaseAG$LogTexture($outer, id, premultiplied) {
    this.$outer = $outer;
    AG$Texture.call(this, this.$outer);
    this.id = id;
    this.premultiplied_9can76$_0 = premultiplied;
  }
  Object.defineProperty(LogBaseAG$LogTexture.prototype, 'premultiplied', {
    get: function () {
      return this.premultiplied_9can76$_0;
    }
  });
  LogBaseAG$LogTexture.prototype.uploadedSource = function () {
    this.$outer.log_61zpoe$(this.toString() + '.uploadedBitmap(' + this.source + ', ' + this.source.width + ', ' + this.source.height + ')');
  };
  LogBaseAG$LogTexture.prototype.close = function () {
    AG$Texture.prototype.close.call(this);
    this.$outer.log_61zpoe$(this.toString() + '.close()');
  };
  LogBaseAG$LogTexture.prototype.toString = function () {
    return 'Texture[' + this.id + ']';
  };
  LogBaseAG$LogTexture.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LogTexture',
    interfaces: [AG$Texture]
  };
  function LogBaseAG$LogBuffer($outer, id, kind) {
    this.$outer = $outer;
    AG$Buffer.call(this, kind);
    this.id = id;
  }
  Object.defineProperty(LogBaseAG$LogBuffer.prototype, 'logmem', {
    get: function () {
      return this.mem;
    }
  });
  Object.defineProperty(LogBaseAG$LogBuffer.prototype, 'logmemOffset', {
    get: function () {
      return this.memOffset;
    }
  });
  Object.defineProperty(LogBaseAG$LogBuffer.prototype, 'logmemLength', {
    get: function () {
      return this.memLength;
    }
  });
  LogBaseAG$LogBuffer.prototype.afterSetMem = function () {
    this.$outer.log_61zpoe$(this.toString() + '.afterSetMem(mem[' + ensureNotNull(this.mem).size + '])');
  };
  LogBaseAG$LogBuffer.prototype.close = function () {
    this.$outer.log_61zpoe$(this.toString() + '.close()');
  };
  LogBaseAG$LogBuffer.prototype.toString = function () {
    return 'Buffer[' + this.id + ']';
  };
  LogBaseAG$LogBuffer.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LogBuffer',
    interfaces: [AG$Buffer]
  };
  function LogBaseAG$LogRenderBuffer($outer, id) {
    this.$outer = $outer;
    AG$RenderBuffer.call(this, this.$outer);
    this.id_hh6z42$_0 = id;
  }
  Object.defineProperty(LogBaseAG$LogRenderBuffer.prototype, 'id', {
    get: function () {
      return this.id_hh6z42$_0;
    }
  });
  LogBaseAG$LogRenderBuffer.prototype.setSize_vux9f0$ = function (width, height) {
    this.$outer.log_61zpoe$(this.toString() + '.setSize(' + width + ', ' + height + ')');
  };
  LogBaseAG$LogRenderBuffer.prototype.set = function () {
    this.$outer.log_61zpoe$(this.toString() + '.set()');
  };
  LogBaseAG$LogRenderBuffer.prototype.close = function () {
    this.$outer.log_61zpoe$(this.toString() + '.close()');
  };
  LogBaseAG$LogRenderBuffer.prototype.toString = function () {
    return 'RenderBuffer[' + this.id + ']';
  };
  LogBaseAG$LogRenderBuffer.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LogRenderBuffer',
    interfaces: [AG$RenderBuffer]
  };
  LogBaseAG.prototype.createTexture_6taknv$ = function (premultiplied) {
    var tmp$;
    var $receiver = new LogBaseAG$LogTexture(this, (tmp$ = this.textureId_b6t5ld$_0, this.textureId_b6t5ld$_0 = tmp$ + 1 | 0, tmp$), premultiplied);
    this.log_61zpoe$('createTexture():' + $receiver.id);
    return $receiver;
  };
  LogBaseAG.prototype.createBuffer_g6fstm$ = function (kind) {
    var tmp$;
    var $receiver = new LogBaseAG$LogBuffer(this, (tmp$ = this.bufferId_ms97wy$_0, this.bufferId_ms97wy$_0 = tmp$ + 1 | 0, tmp$), kind);
    this.log_61zpoe$('createBuffer(' + kind + '):' + $receiver.id);
    return $receiver;
  };
  LogBaseAG.prototype.draw_y6md32$ = function (batch) {
    ...
    try {
      ...
      var vertexBuffer = Kotlin.isType(tmp$ = vertices, LogBaseAG$LogBuffer) ? tmp$ : throwCCE();
      var vertexMem = ensureNotNull(vertexBuffer.logmem);
      var vertexMemOffset = vertexBuffer.logmemOffset;
      var indexMem = (Kotlin.isType(tmp$_0 = indices, LogBaseAG$LogBuffer) ? tmp$_0 : throwCCE()).logmem;
  ...
  LogBaseAG.prototype.disposeTemporalPerFrameStuff = function () {
    this.log_61zpoe$('disposeTemporalPerFrameStuff()');
  };
  LogBaseAG.prototype.createRenderBuffer = function () {
    var tmp$;
    var $receiver = new LogBaseAG$LogRenderBuffer(this, (tmp$ = this.renderBufferId_s27xuk$_0, this.renderBufferId_s27xuk$_0 = tmp$ + 1 | 0, tmp$));
    this.log_61zpoe$('createRenderBuffer():' + $receiver.id);
    return $receiver;
  };
  LogBaseAG.prototype.flipInternal = function () {
    this.log_61zpoe$('flipInternal()');
  };
  LogBaseAG.prototype.readColor_59u9qz$ = function (bitmap) {
    this.log_61zpoe$(this.toString() + '.readBitmap(' + bitmap + ')');
  };
  LogBaseAG.prototype.readDepth_l5lmba$ = function (width, height, out) {
    this.log_61zpoe$(this.toString() + '.readDepth(' + width + ', ' + height + ', ' + out + ')');
  };
  LogBaseAG.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'LogBaseAG',
    interfaces: [AG]
  };
  ...
  function toNewGlslStringResult($receiver, gles, version, compatibility, android) {
    if (gles === void 0)
      gles = true;
    if (version === void 0)
    ...
    if (android === void 0)
      android = false;
    return toNewGlslStringResult_0($receiver, new GlslConfig(gles, version, compatibility, android));
  }
  function toNewGlslStringResult_0($receiver, config) {
    return (new GlslGenerator($receiver.type, config)).generateResult_57b21j$($receiver.stm);
  }
  function GlslConfig(gles, version, compatibility, android, programConfig) {
    ...
    if (android === void 0)
      android = false;
    if (programConfig === void 0)
      programConfig = ProgramConfig$Companion_getInstance().DEFAULT;
    this.gles = gles;
  ...
  GlslConfig.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'GlslConfig',
    interfaces: []
  };
  GlslConfig.prototype.component1 = function () {
    return this.gles;
  };
  GlslConfig.prototype.component2 = function () {
    return this.version;
  };
  GlslConfig.prototype.component3 = function () {
    return this.compatibility;
  };
  GlslConfig.prototype.component4 = function () {
    return this.android;
  };
  GlslConfig.prototype.component5 = function () {
    return this.programConfig;
  };
  GlslConfig.prototype.copy_srg1e4$ = function (gles, version, compatibility, android, programConfig) {
    return new GlslConfig(gles === void 0 ? this.gles : gles, version === void 0 ? this.version : version, compatibility === void 0 ? this.compatibility : compatibility, android === void 0 ? this.android : android, programConfig === void 0 ? this.programConfig : programConfig);
  };
  GlslConfig.prototype.toString = function () {
    return 'GlslConfig(gles=' + Kotlin.toString(this.gles) + (', version=' + Kotlin.toString(this.version)) + (', compatibility=' + Kotlin.toString(this.compatibility)) + (', android=' + Kotlin.toString(this.android)) + (', programConfig=' + Kotlin.toString(this.programConfig)) + ')';
  };
  GlslConfig.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.gles) | 0;
    result = result * 31 + Kotlin.hashCode(this.version) | 0;
    result = result * 31 + Kotlin.hashCode(this.compatibility) | 0;
    result = result * 31 + Kotlin.hashCode(this.android) | 0;
    result = result * 31 + Kotlin.hashCode(this.programConfig) | 0;
    return result;
  };
  GlslConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.gles, other.gles) && Kotlin.equals(this.version, other.version) && Kotlin.equals(this.compatibility, other.compatibility) && Kotlin.equals(this.android, other.android) && Kotlin.equals(this.programConfig, other.programConfig)))));
  };
  function GlslGenerator(kind, config) {
    GlslGenerator$Companion_getInstance();
    if (config === void 0)
      config = new GlslConfig();
  ...
  Object.defineProperty(GlslGenerator.prototype, 'gles', {
    get: function () {
      return this.config.gles;
    }
  });
  Object.defineProperty(GlslGenerator.prototype, 'version', {
    get: function () {
      return this.config.version;
    }
  });
  Object.defineProperty(GlslGenerator.prototype, 'compatibility', {
    get: function () {
      return this.config.compatibility;
    }
  });
  Object.defineProperty(GlslGenerator.prototype, 'android', {
    get: function () {
  ...
  GlslGenerator.prototype.typeToString_b2kxjc$ = function (type) {
    switch (type.name) {
      ...
      case 'Mat4':
        return 'mat4';
      case 'TextureUnit':
        return this.config.programConfig.externalTextureSampler ? 'samplerExternalOES' : 'sampler2D';
  ...
  function GlslGenerator$generateResult$lambda(this$GlslGenerator) {
    return function ($receiver) {
      ...
      if (this$GlslGenerator.gles) {
        ...
        }if (this$GlslGenerator.config.programConfig.externalTextureSampler) {
          $receiver.line_61zpoe$('#extension GL_OES_EGL_image_external : require');
  ...
  function GlslGenerator_init(kind, gles, version, compatibility, $this) {
    if (gles === void 0)
      gles = true;
    if (version === void 0)
      version = GlslGenerator$Companion_getInstance().DEFAULT_VERSION;
    if (compatibility === void 0)
      compatibility = true;
    $this = $this || Object.create(GlslGenerator.prototype);
    GlslGenerator.call($this, kind, new GlslConfig(gles, version, compatibility));
    return $this;
  }
  ...
  function ProgramConfig(externalTextureSampler) {
    ProgramConfig$Companion_getInstance();
    if (externalTextureSampler === void 0)
      externalTextureSampler = false;
    this.externalTextureSampler = externalTextureSampler;
  }
  function ProgramConfig$Companion() {
    ProgramConfig$Companion_instance = this;
    this.DEFAULT = new ProgramConfig();
    this.EXTERNAL_TEXTURE_SAMPLER = new ProgramConfig(true);
  }
  ProgramConfig$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var ProgramConfig$Companion_instance = null;
  function ProgramConfig$Companion_getInstance() {
    if (ProgramConfig$Companion_instance === null) {
      new ProgramConfig$Companion();
    }return ProgramConfig$Companion_instance;
  }
  ProgramConfig.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ProgramConfig',
    interfaces: []
  };
  ProgramConfig.prototype.component1 = function () {
    return this.externalTextureSampler;
  };
  ProgramConfig.prototype.copy_6taknv$ = function (externalTextureSampler) {
    return new ProgramConfig(externalTextureSampler === void 0 ? this.externalTextureSampler : externalTextureSampler);
  };
  ProgramConfig.prototype.toString = function () {
    return 'ProgramConfig(externalTextureSampler=' + Kotlin.toString(this.externalTextureSampler) + ')';
  };
  ProgramConfig.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.externalTextureSampler) | 0;
    return result;
  };
  ProgramConfig.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.externalTextureSampler, other.externalTextureSampler))));
  };
  ...
  KmlGlJsCanvas.prototype.uniformMatrix2fv_24ez2x$ = function (location, count, transpose, value) {
    this.gl.uniformMatrix2fv(this.get_0(location), transpose, this.sliceIfRequired_0(value.arrayFloat, (count * 2 | 0) * 2 | 0));
  };
  KmlGlJsCanvas.prototype.uniformMatrix3fv_24ez2x$ = function (location, count, transpose, value) {
    this.gl.uniformMatrix3fv(this.get_0(location), transpose, this.sliceIfRequired_0(value.arrayFloat, (count * 3 | 0) * 3 | 0));
  };
  KmlGlJsCanvas.prototype.uniformMatrix4fv_24ez2x$ = function (location, count, transpose, value) {
    this.gl.uniformMatrix4fv(this.get_0(location), transpose, this.sliceIfRequired_0(value.arrayFloat, (count * 4 | 0) * 4 | 0));
  };
  ...
  KmlGlJsCanvas.prototype.sliceIfRequired_0 = function ($receiver, count) {
    return $receiver.length === count ? $receiver : new Float32Array($receiver.buffer, 0, count);
  };
  ...
  package$kgl.checked_lryqz3$ = checked;
  package$kgl.checkedIf_h6ygrc$ = checkedIf;
  ...
  package$korag.ForcedTexId = ForcedTexId;
  package$korag.ForcedTexTarget = ForcedTexTarget;
  ...
  LogBaseAG.LogTexture = LogBaseAG$LogTexture;
  LogBaseAG.LogBuffer = LogBaseAG$LogBuffer;
  LogBaseAG.LogRenderBuffer = LogBaseAG$LogRenderBuffer;
  package$log.LogBaseAG = LogBaseAG;
  ...
  package$gl.toNewGlslStringResult_gxyl3y$ = toNewGlslStringResult;
  package$gl.toNewGlslStringResult_bmg8cf$ = toNewGlslStringResult_0;
  package$gl.GlslConfig = GlslConfig;
  ...
  package$gl.GlslGenerator_init_hdsgew$ = GlslGenerator_init;
  ...
  Object.defineProperty(ProgramConfig, 'Companion', {
    get: ProgramConfig$Companion_getInstance
  });
  package$shader.ProgramConfig = ProgramConfig;
  ...
  package$internal_2.toList_x0o439$ = toList_1;
  AG$RenderBuffer.prototype.unset = AG$BaseRenderBuffer.prototype.unset;
