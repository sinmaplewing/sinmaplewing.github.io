(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      ...
      throw new Error("Error loading module 'korinject-root-korinject'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'korinject-root-korinject'.");
    }root['korinject-root-korinject'] = factory(typeof this['korinject-root-korinject'] === 'undefined' ? {} : this['korinject-root-korinject'], kotlin, this['kotlinx-coroutines-core']);
  }
  ...
  function Coroutine$withInjector$lambda(closure$block_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$closure$block = closure$block_0;
  }
  Coroutine$withInjector$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$withInjector$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$withInjector$lambda.prototype.constructor = Coroutine$withInjector$lambda;
  Coroutine$withInjector$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
  ...
  function withInjector$lambda(closure$block_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$withInjector$lambda(closure$block_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function withInjector(injector, block, continuation) {
    return withContext(new AsyncInjectorContext(injector), withInjector$lambda(block), continuation);
  }
  function injector(continuation) {
    var tmp$, tmp$_0;
    var tmp$_1;
    if ((tmp$_0 = (tmp$ = continuation.context.get_j3r2sn$(AsyncInjectorContext$Companion_getInstance())) != null ? tmp$.injector : null) != null)
      tmp$_1 = tmp$_0;
    else {
      throw IllegalStateException_init('AsyncInjector not in the context, please call withInjector function'.toString());
    }
    return tmp$_1;
  }
  function AsyncInjectorContext(injector) {
    AsyncInjectorContext$Companion_getInstance();
    this.injector = injector;
  }
  function AsyncInjectorContext$Companion() {
    AsyncInjectorContext$Companion_instance = this;
  }
  AsyncInjectorContext$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: [CoroutineContext$Key]
  };
  var AsyncInjectorContext$Companion_instance = null;
  function AsyncInjectorContext$Companion_getInstance() {
    if (AsyncInjectorContext$Companion_instance === null) {
      new AsyncInjectorContext$Companion();
    }return AsyncInjectorContext$Companion_instance;
  }
  Object.defineProperty(AsyncInjectorContext.prototype, 'key', {
    get: function () {
      return AsyncInjectorContext$Companion_getInstance();
    }
  });
  AsyncInjectorContext.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'AsyncInjectorContext',
  ...
  package$korinject.withInjector_qqioh3$ = withInjector;
  package$korinject.injector = injector;
  Object.defineProperty(AsyncInjectorContext, 'Companion', {
    get: AsyncInjectorContext$Companion_getInstance
  });
  package$korinject.AsyncInjectorContext = AsyncInjectorContext;
  ...
  AsyncInjectorContext.prototype.fold_3cc69b$ = CoroutineContext$Element.prototype.fold_3cc69b$;
  AsyncInjectorContext.prototype.get_j3r2sn$ = CoroutineContext$Element.prototype.get_j3r2sn$;
  AsyncInjectorContext.prototype.minusKey_yeqjby$ = CoroutineContext$Element.prototype.minusKey_yeqjby$;
  AsyncInjectorContext.prototype.plus_1fupul$ = CoroutineContext$Element.prototype.plus_1fupul$;
