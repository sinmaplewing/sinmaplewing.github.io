(function (root, factory) {
  ...
  KmemGC$ObjectLiteral.prototype = Object.create(KmemGCImpl.prototype);
  KmemGC$ObjectLiteral.prototype.constructor = KmemGC$ObjectLiteral;
  ...
  var array_indexOf = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.array_indexOf_393yuv$', function (starting, selfSize, subSize, equal) {
    var tmp$;
    tmp$ = selfSize - subSize | 0;
    for (var n = starting; n < tmp$; n++) {
      var eq = 0;
      for (var m = 0; m < subSize; m++) {
        if (!equal(n + m | 0, m)) {
          break;
        }eq = eq + 1 | 0;
      }
  ...
  function indexOf$lambda(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      var tmp$;
      tmp$ = $receiver.length - sub.length | 0;
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
          array_indexOf$result = n;
          break array_indexOf$break;
        }}
      array_indexOf$result = -1;
    }
     while (false);
    return array_indexOf$result;
  }
  function indexOf$lambda_0(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf_0($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_0($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_1(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf_1($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_1($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_2(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf_2($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_2($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_3(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf_3($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_3($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_4(this$indexOf, closure$sub) {
    return function (n, m) {
      return equals(this$indexOf[n], closure$sub[m]);
    };
  }
  function indexOf_4($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_4($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_5(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf_5($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_5($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_6(this$indexOf, closure$sub) {
    return function (n, m) {
      return this$indexOf[n] === closure$sub[m];
    };
  }
  function indexOf_6($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_6($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  function indexOf$lambda_7(this$indexOf, closure$sub) {
    return function (n, m) {
      return equals(this$indexOf[n], closure$sub[m]);
    };
  }
  function indexOf_7($receiver, sub, starting) {
    if (starting === void 0)
      starting = 0;
    var array_indexOf$result;
    array_indexOf$break: do {
      ...
      for (var n = starting; n < tmp$; n++) {
        var eq = 0;
        for (var m = 0; m < sub.length; m++) {
          if (!indexOf$lambda_7($receiver, sub)(n + m | 0, m)) {
            break;
          }eq = eq + 1 | 0;
        }
        if (eq === sub.length) {
  ...
  FBuffer$Companion.prototype.allocUnaligned_za3lpa$ = function (size) {
    return new FBuffer(new ArrayBuffer_init(size), size);
  };
  FBuffer$Companion.prototype.alloc_za3lpa$ = function (size) {
    return this.allocUnaligned_za3lpa$(this.sizeAligned_0(size));
  };
  ...
  function Int53(value) {
    Int53$Companion_getInstance();
    this.value = value;
  }
  function Int53$Companion() {
    Int53$Companion_instance = this;
    this.MAX_VALUE = new Int53(4.503599627370495E15);
    this.MIN_VALUE = new Int53(-4.503599627370495E15);
    this.MAX_UINT32_0 = 4.294967295E9;
  }
  Int53$Companion.prototype.fromDoubleClamped_14dthe$ = function (value) {
    if (value > this.MAX_VALUE.value)
      return this.MAX_VALUE;
    else if (value < this.MIN_VALUE.value)
      return this.MIN_VALUE;
    else {
      return new Int53(value < 0.0 ? Math_0.ceil(value) : Math_0.floor(value));
    }
  };
  Int53$Companion.prototype.fromLowHigh_vux9f0$ = function (low, high) {
    var $receiver = Kotlin.Long.fromInt(low).or(Kotlin.Long.fromInt(signExtend(high & 2097151, 21)).shiftLeft(32));
    return Int53.Companion.fromDoubleClamped_14dthe$($receiver.toNumber());
  };
  Int53$Companion.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'Companion',
    interfaces: []
  };
  var Int53$Companion_instance = null;
  function Int53$Companion_getInstance() {
    if (Int53$Companion_instance === null) {
      new Int53$Companion();
    }return Int53$Companion_instance;
  }
  Object.defineProperty(Int53.prototype, 'high', {
    get: function () {
      return this.long.shiftRightUnsigned(32).and(Kotlin.Long.fromInt(mask(21))).toInt();
    }
  });
  Object.defineProperty(Int53.prototype, 'low', {
    get: function () {
      return this.long.toInt();
    }
  });
  Int53.prototype.unaryMinus = function () {
    return new Int53(-this.value);
  };
  Int53.prototype.unaryPlus = function () {
    return new Int53(+this.value);
  };
  Int53.prototype.plus_14dthe$ = function (other) {
    return Int53$Companion_getInstance().fromDoubleClamped_14dthe$(this.value + other);
  };
  Int53.prototype.plus_za3lpa$ = function (other) {
    return this.plus_14dthe$(other);
  };
  Int53.prototype.plus_xhtxb$ = function (other) {
    return this.plus_14dthe$(other.toDouble());
  };
  Int53.prototype.plus_3p81yu$ = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.Int53.plus_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (other) {
      return this.plus_14dthe$(numberToDouble(other));
    };
  }));
  Int53.prototype.minus_14dthe$ = function (other) {
    return Int53$Companion_getInstance().fromDoubleClamped_14dthe$(this.value - other);
  };
  Int53.prototype.minus_za3lpa$ = function (other) {
    return this.minus_14dthe$(other);
  };
  Int53.prototype.minus_xhtxb$ = function (other) {
    return this.minus_14dthe$(other.toDouble());
  };
  Int53.prototype.minus_3p81yu$ = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.Int53.minus_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (other) {
      return this.minus_14dthe$(numberToDouble(other));
    };
  }));
  Int53.prototype.times_14dthe$ = function (other) {
    return Int53$Companion_getInstance().fromDoubleClamped_14dthe$(this.value * other);
  };
  Int53.prototype.times_za3lpa$ = function (other) {
    return this.times_14dthe$(other);
  };
  Int53.prototype.times_xhtxb$ = function (other) {
    return this.times_14dthe$(other.toDouble());
  };
  Int53.prototype.times_3p81yu$ = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.Int53.times_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (other) {
      return this.times_14dthe$(numberToDouble(other));
    };
  }));
  Int53.prototype.div_14dthe$ = function (other) {
    return Int53$Companion_getInstance().fromDoubleClamped_14dthe$(this.value / other);
  };
  Int53.prototype.div_za3lpa$ = function (other) {
    return this.div_14dthe$(other);
  };
  Int53.prototype.div_xhtxb$ = function (other) {
    return this.div_14dthe$(other.toDouble());
  };
  Int53.prototype.div_3p81yu$ = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.Int53.div_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (other) {
      return this.div_14dthe$(numberToDouble(other));
    };
  }));
  Int53.prototype.rem_14dthe$ = function (other) {
    return Int53$Companion_getInstance().fromDoubleClamped_14dthe$(this.value % other);
  };
  Int53.prototype.rem_za3lpa$ = function (other) {
    return this.rem_14dthe$(other);
  };
  Int53.prototype.rem_xhtxb$ = function (other) {
    return this.rem_14dthe$(other.toDouble());
  };
  Int53.prototype.rem_3p81yu$ = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.Int53.rem_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (other) {
      return this.rem_14dthe$(numberToDouble(other));
    };
  }));
  Int53.prototype.and_xhtxb$ = function (other) {
    return Int53$Companion_getInstance().fromLowHigh_vux9f0$(this.low & other.low, this.high & other.high);
  };
  Int53.prototype.or_xhtxb$ = function (other) {
    return Int53$Companion_getInstance().fromLowHigh_vux9f0$(this.low | other.low, this.high | other.high);
  };
  Int53.prototype.xor_xhtxb$ = function (other) {
    return Int53$Companion_getInstance().fromLowHigh_vux9f0$(this.low ^ other.low, this.high ^ other.high);
  };
  Int53.prototype.inv = function () {
    return Int53$Companion_getInstance().fromLowHigh_vux9f0$(~this.low, ~this.high);
  };
  Object.defineProperty(Int53.prototype, 'int', {
    get: function () {
      return numberToInt(this.value);
    }
  });
  Object.defineProperty(Int53.prototype, 'long', {
    get: function () {
      return Kotlin.Long.fromNumber(this.value);
    }
  });
  Object.defineProperty(Int53.prototype, 'double', {
    get: function () {
      return this.value;
    }
  });
  Int53.prototype.toInt = function () {
    return this.int;
  };
  Int53.prototype.toLong = function () {
    return this.long;
  };
  Int53.prototype.toDouble = function () {
    return this.double;
  };
  Int53.prototype.compareTo_14dthe$ = function (other) {
    return Kotlin.compareTo(this.value, other);
  };
  Int53.prototype.compareTo_za3lpa$ = function (other) {
    return this.compareTo_14dthe$(other);
  };
  Int53.prototype.compareTo_11rb$ = function (other) {
    return this.compareTo_14dthe$(other.toDouble());
  };
  Int53.prototype.compareTo_3p81yu$ = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.Int53.compareTo_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (other) {
      return this.compareTo_14dthe$(numberToDouble(other));
    };
  }));
  Int53.prototype.toString = function () {
    return removeSuffix(Kotlin.Long.fromNumber(this.value).toString(), '.0');
  };
  Int53.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Int53',
  ...
  Int53.prototype.unbox = function () {
    return this.value;
  };
  Int53.prototype.hashCode = function () {
    var result = 0;
    result = result * 31 + Kotlin.hashCode(this.value) | 0;
    return result;
  };
  Int53.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.value, other.value))));
  };
  var toInt53 = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.toInt53_pdl1vz$', wrapFunction(function () {
    var toDouble = Kotlin.kotlin.text.toDouble_pdl1vz$;
    var Int53 = _.com.soywiz.kmem.Int53;
    return function ($receiver) {
      var $receiver_0 = toDouble($receiver);
      return Int53.Companion.fromDoubleClamped_14dthe$($receiver_0);
    };
  }));
  var toInt53OrNull = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.toInt53OrNull_pdl1vz$', wrapFunction(function () {
    var toDoubleOrNull = Kotlin.kotlin.text.toDoubleOrNull_pdl1vz$;
    var Int53 = _.com.soywiz.kmem.Int53;
    return function ($receiver) {
      var tmp$;
      return (tmp$ = toDoubleOrNull($receiver)) != null ? Int53.Companion.fromDoubleClamped_14dthe$(tmp$) : null;
    };
  }));
  var toInt53_0 = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.toInt53_s8ev3n$', wrapFunction(function () {
    var Int53 = _.com.soywiz.kmem.Int53;
    return function ($receiver) {
      return Int53.Companion.fromDoubleClamped_14dthe$($receiver);
    };
  }));
  var toInt53_1 = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.toInt53_yrwdxr$', wrapFunction(function () {
    var Int53 = _.com.soywiz.kmem.Int53;
    return function ($receiver) {
      return Int53.Companion.fromDoubleClamped_14dthe$($receiver);
    };
  }));
  var toInt53_2 = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.toInt53_mts6qi$', wrapFunction(function () {
    var Int53 = _.com.soywiz.kmem.Int53;
    return function ($receiver) {
      return Int53.Companion.fromDoubleClamped_14dthe$($receiver.toNumber());
    };
  }));
  var toInt53_3 = defineInlineFunction('kmem-root-kmem.com.soywiz.kmem.toInt53_rcaex3$', wrapFunction(function () {
    var Int53 = _.com.soywiz.kmem.Int53;
    var numberToDouble = Kotlin.numberToDouble;
    return function ($receiver) {
      return Int53.Companion.fromDoubleClamped_14dthe$(numberToDouble($receiver));
    };
  }));
  function KmemGCImpl() {
    this.threshold_p50yqx$_0 = 0;
    this.thresholdAllocations_azm594$_0 = L0;
    this.autotune_um1mvb$_0 = true;
    this.cyclicCollectorEnabled_eyqx03$_0 = true;
  }
  KmemGCImpl.prototype.collect = function () {
  };
  KmemGCImpl.prototype.collectCyclic = function () {
  };
  KmemGCImpl.prototype.suspend = function () {
  };
  KmemGCImpl.prototype.resume = function () {
  };
  KmemGCImpl.prototype.stop = function () {
  };
  KmemGCImpl.prototype.start = function () {
  };
  Object.defineProperty(KmemGCImpl.prototype, 'threshold', {
    get: function () {
      return this.threshold_p50yqx$_0;
    },
    set: function (threshold) {
      this.threshold_p50yqx$_0 = threshold;
    }
  });
  Object.defineProperty(KmemGCImpl.prototype, 'thresholdAllocations', {
    get: function () {
      return this.thresholdAllocations_azm594$_0;
    },
    set: function (thresholdAllocations) {
      this.thresholdAllocations_azm594$_0 = thresholdAllocations;
    }
  });
  Object.defineProperty(KmemGCImpl.prototype, 'autotune', {
    get: function () {
      return this.autotune_um1mvb$_0;
    },
    set: function (autotune) {
      this.autotune_um1mvb$_0 = autotune;
    }
  });
  Object.defineProperty(KmemGCImpl.prototype, 'cyclicCollectorEnabled', {
    get: function () {
      return this.cyclicCollectorEnabled_eyqx03$_0;
    },
    set: function (cyclicCollectorEnabled) {
      this.cyclicCollectorEnabled_eyqx03$_0 = cyclicCollectorEnabled;
    }
  });
  KmemGCImpl.$metadata$ = {
    kind: Kind_CLASS,
  ...
  function KmemExperimental() {
  }
  KmemExperimental.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'KmemExperimental',
  ...
  function KmemGC$ObjectLiteral() {
    KmemGCImpl.call(this);
  }
  KmemGC$ObjectLiteral.$metadata$ = {
    kind: Kind_CLASS,
    interfaces: [KmemGCImpl]
  };
  var KmemGC;
  ...
  package$kmem.array_indexOf_393yuv$ = array_indexOf;
  $$importsForInline$$['kmem-root-kmem'] = _;
  package$kmem.indexOf_t6k4jl$ = indexOf;
  package$kmem.indexOf_2t95dr$ = indexOf_0;
  package$kmem.indexOf_kt7d61$ = indexOf_1;
  package$kmem.indexOf_qujdmp$ = indexOf_2;
  package$kmem.indexOf_cv6y29$ = indexOf_3;
  package$kmem.indexOf_qckydb$ = indexOf_4;
  package$kmem.indexOf_da8j4n$ = indexOf_5;
  package$kmem.indexOf_mt9db3$ = indexOf_6;
  package$kmem.indexOf_tl8f3d$ = indexOf_7;
  ...
  Object.defineProperty(Int53, 'Companion', {
    get: Int53$Companion_getInstance
  });
  package$kmem.Int53 = Int53;
  package$kmem.toInt53_yrwdxr$ = toInt53_1;
  package$kmem.toInt53_pdl1vz$ = toInt53;
  package$kmem.toInt53OrNull_pdl1vz$ = toInt53OrNull;
  package$kmem.toInt53_s8ev3n$ = toInt53_0;
  package$kmem.toInt53_mts6qi$ = toInt53_2;
  package$kmem.toInt53_rcaex3$ = toInt53_3;
  package$kmem.KmemGCImpl = KmemGCImpl;
  ...
  var package$annotations = package$kmem.annotations || (package$kmem.annotations = {});
  package$annotations.KmemExperimental = KmemExperimental;
  ...
  Object.defineProperty(package$kmem, 'KmemGC', {
    get: function () {
      return KmemGC;
    }
  });
  KmemGC = new KmemGC$ObjectLiteral();
